...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='T1.25VI', stellar_effective_temperature=6103.655393775693, stellar_radius=29.835253119638274, stellar_mass=3.2167459257883855, stellar_luminosity=-0.4692905658902793, stellar_surface_gravity=3.6915604891693397, stellar_age=1.4646179353122823),
                     'q6': Star(spectral_type='F3.5I', stellar_effective_temperature=2546.532840602783, stellar_radius=10.772237329633933, stellar_mass=2.3034994856161344, stellar_luminosity=1.7571536579423788, stellar_surface_gravity=3.5221714616413946, stellar_age=4.131775532444522),
                     'q7': -0.38874463620299177,
                     'q8': 7.52125109092659}
