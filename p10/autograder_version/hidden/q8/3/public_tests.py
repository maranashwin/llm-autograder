...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='W4.25VI-W4.5', stellar_effective_temperature=6196.760220225889, stellar_radius=32.861849409756736, stellar_mass=4.22002739825107, stellar_luminosity=-0.6684496801218551, stellar_surface_gravity=2.582912393353999, stellar_age=1.3298414139690014),
                     'q6': Star(spectral_type='F6.75III', stellar_effective_temperature=3946.674297430551, stellar_radius=30.16800587642563, stellar_mass=3.192983774763977, stellar_luminosity=-0.1177002593893087, stellar_surface_gravity=3.9900639933182545, stellar_age=4.026103678769987),
                     'q7': -0.09876370464452026,
                     'q8': 7.226786708665101}
