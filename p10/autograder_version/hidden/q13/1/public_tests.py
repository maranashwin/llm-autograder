...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='G1.25', stellar_effective_temperature=1971.3520277956927, stellar_radius=24.069946383872114, stellar_mass=3.1379589098275527, stellar_luminosity=-0.17949423359609287, stellar_surface_gravity=2.5320745286460467, stellar_age=2.6339941989283746),
                     'q6': Star(spectral_type='B5.25VI-II', stellar_effective_temperature=6403.7509723005205, stellar_radius=26.84283066458799, stellar_mass=0.5382233624354731, stellar_luminosity=1.246288441807828, stellar_surface_gravity=2.939907905160002, stellar_age=6.99721124793986),
                     'q7': -0.1512755699607474,
                     'q8': 7.083868351028681,
                     'q9': 6292.325883440936,
                     'q10': 'CoRoT 62',
                     'q11': 7.614534880102826,
                     ...
                     'q12': Planet(planet_name='nu 7772 1', host_name='nu 7772', discovery_method='Orbital Brightness Modulation', discovery_year=2014, controversial_flag=False, orbital_period=874.5205468032887, planet_radius=15.09825992988414, planet_mass=5643.5167068470655, semi_major_radius=114.7110087751187, eccentricity=0.012049191343736769, equilibrium_temperature=547.846108886784, insolation_flux=1254.9500506370712),
                     'q13': [Planet(planet_name='mu2-7529 1', host_name='CoRoT 6342', discovery_method='Pulsation Timing Variations', discovery_year=2017, controversial_flag=False, orbital_period=344.3089009044006, planet_radius=8.512755411605712, planet_mass=8904.749451513062, semi_major_radius=79.20408725900823, eccentricity=0.07443522008027775, equilibrium_temperature=337.74355085067, insolation_flux=1953.0379479606577),
                             Planet(planet_name='TOI 1684 a', host_name='kap 1585', discovery_method='Pulsation Timing Variations', discovery_year=2018, controversial_flag=False, orbital_period=972.9464852735368, planet_radius=13.198212002126631, planet_mass=3281.1029308610405, semi_major_radius=73.83503178642201, eccentricity=0.03332288754567131, equilibrium_temperature=509.14600026679113, insolation_flux=1254.9500506370712),
                             Planet(planet_name='omi 2385 1', host_name='rho-2237', discovery_method='Transit', discovery_year=2018, controversial_flag=True, orbital_period=532.239949731753, planet_radius=10.001149117438313, planet_mass=8916.30125546465, semi_major_radius=129.14944675421955, eccentricity=0.03265341775046772, equilibrium_temperature=1177.4870820548795, insolation_flux=1743.3511357810512),
                             Planet(planet_name='HD-5278 1', host_name='kap 2255', discovery_method='Disk Kinematics', discovery_year=2014, controversial_flag=False, orbital_period=840.7959396598503, planet_radius=16.891026775949754, planet_mass=4623.155417293642, semi_major_radius=62.44699680209848, eccentricity=0.08405066961026217, equilibrium_temperature=978.680164264395, insolation_flux=3011.2031276578073),
                             Planet(planet_name='GJ 6806 a', host_name='iot 3130', discovery_method='Eclipse Timing Variations', discovery_year=2020, controversial_flag=False, orbital_period=755.1456652748718, planet_radius=7.984708523548882, planet_mass=8458.374691204248, semi_major_radius=51.14130911689331, eccentricity=0.0663543801805346, equilibrium_temperature=1142.8655299252277, insolation_flux=1614.3814939829713)]}
