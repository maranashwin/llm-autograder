...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='D6.75III-VI', stellar_effective_temperature=2474.2512556451165, stellar_radius=48.14597152980505, stellar_mass=4.005577261318419, stellar_luminosity=-1.6688393210566435, stellar_surface_gravity=2.3245492799786187, stellar_age=5.937546545832452),
                     'q6': Star(spectral_type='M2', stellar_effective_temperature=4219.772373208087, stellar_radius=30.30525073587767, stellar_mass=1.350169102176291, stellar_luminosity=-1.1001211802472017, stellar_surface_gravity=3.735789724126488, stellar_age=4.704553008687375),
                     'q7': -0.2477254839987293,
                     'q8': 6.937425615328511,
                     'q9': 6997.496011326219,
                     'q10': 'mu2-5102',
                     'q11': 6.3279317516995786,
                     ...
                     'q12': Planet(planet_name='2MASS 7557 a', host_name='2MASS 7557', discovery_method='Radial Velocity', discovery_year=2019, controversial_flag=True, orbital_period=561.2184967807415, planet_radius=10.936702399784835, planet_mass=3254.3403938013016, semi_major_radius=209.84836368641115, eccentricity=0.04709104379291683, equilibrium_temperature=1200.7941258584437, insolation_flux=1269.3314330688852),
                     'q13': [Planet(planet_name='mu-1403 a', host_name='mu-1403', discovery_method='Eclipse Timing Variations', discovery_year=2022, controversial_flag=False, orbital_period=498.95915020397473, planet_radius=7.441639804498183, planet_mass=5003.086407476036, semi_major_radius=152.48713909198196, eccentricity=0.02524617163067539, equilibrium_temperature=1132.3168447673831, insolation_flux=1319.8881479776228),
                             Planet(planet_name='Kepler-1138 1', host_name='Kepler-1138', discovery_method='Radial Velocity', discovery_year=2018, controversial_flag=True, orbital_period=527.3972677793943, planet_radius=5.847452566044694, planet_mass=4635.925185139139, semi_major_radius=86.61034467933125, eccentricity=0.027847537043014566, equilibrium_temperature=660.481913876353, insolation_flux=202.3762820845103),
                             Planet(planet_name='xi-3596 1', host_name='xi-3596', discovery_method='Microlensing', discovery_year=2014, controversial_flag=False, orbital_period=714.1776817786797, planet_radius=14.06398515654786, planet_mass=6632.517859735606, semi_major_radius=74.7842676839792, eccentricity=0.05759019276334374, equilibrium_temperature=1326.2306058648792, insolation_flux=1014.2487762967627),
                             Planet(planet_name='kap-3096 a', host_name='kap-3096', discovery_method='Disk Kinematics', discovery_year=2018, controversial_flag=False, orbital_period=447.13325278831576, planet_radius=5.285845303415453, planet_mass=4216.935184568361, semi_major_radius=46.08269114825733, eccentricity=0.047131455985415044, equilibrium_temperature=1459.2182516991365, insolation_flux=420.30191544438935),
                             Planet(planet_name='WASP-5756 a', host_name='WASP-5756', discovery_method='Pulsation Timing Variations', discovery_year=2021, controversial_flag=False, orbital_period=243.74512099641635, planet_radius=11.096354512956022, planet_mass=4223.811081848357, semi_major_radius=78.40659550522055, eccentricity=0.0242655327256306, equilibrium_temperature=553.3493239417439, insolation_flux=927.4835194814932)]}
