...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='KIV/T7.5', stellar_effective_temperature=6227.14889215173, stellar_radius=44.67509366972899, stellar_mass=1.3224340871251916, stellar_luminosity=0.8702686086121636, stellar_surface_gravity=4.35719385590755, stellar_age=5.841371566631735),
                     'q6': Star(spectral_type='L9.5', stellar_effective_temperature=6214.20575897615, stellar_radius=25.715354418076394, stellar_mass=4.306527848365916, stellar_luminosity=2.0457353301720005, stellar_surface_gravity=3.9801037593185833, stellar_age=7.949539747084696),
                     'q7': 0.26145040759731164,
                     'q8': 6.8647850583852,
                     'q9': 3277.7128023039318,
                     'q10': 'bet 16607',
                     'q11': 5.707150873625924,
                     ...
                     'q12': Planet(planet_name='bet 5219 1', host_name='bet 5219', discovery_method='Microlensing', discovery_year=2020, controversial_flag=False, orbital_period=440.2986939468786, planet_radius=0.9076229302628249, planet_mass=11559.208017066903, semi_major_radius=91.80810773858047, eccentricity=0.03905976344714857, equilibrium_temperature=1887.4504811289971, insolation_flux=176.8632826650571)}
