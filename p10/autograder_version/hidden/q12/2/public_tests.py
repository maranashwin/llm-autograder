...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='TVI', stellar_effective_temperature=5211.504221983696, stellar_radius=33.23853992946615, stellar_mass=1.4807500670473277, stellar_luminosity=-0.3070923637454237, stellar_surface_gravity=3.6411245169406152, stellar_age=5.311271948209647),
                     'q6': Star(spectral_type='TVI', stellar_effective_temperature=5211.504221983696, stellar_radius=33.23853992946615, stellar_mass=1.4807500670473277, stellar_luminosity=-0.3070923637454237, stellar_surface_gravity=3.6411245169406152, stellar_age=5.311271948209647),
                     'q7': -0.12139962696183546,
                     'q8': 8.037334331423493,
                     'q9': 7650.418810770541,
                     'q10': '2MASS-4120',
                     'q11': 6.621181085506812,
                     ...
                     'q12': Planet(planet_name='iot 454 1', host_name='tau 3690', discovery_method='Disk Kinematics', discovery_year=2015, controversial_flag=False, orbital_period=388.3030073031519, planet_radius=16.841275474643343, planet_mass=4166.894072569438, semi_major_radius=60.87340136703091, eccentricity=0.0922982728347161, equilibrium_temperature=1767.5676953447332, insolation_flux=1089.622273004497)}
