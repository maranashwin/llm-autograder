...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='D4.5IV/M2.75I', stellar_effective_temperature=5343.564173272531, stellar_radius=14.35867064516068, stellar_mass=2.025969748363284, stellar_luminosity=1.4627184687718573, stellar_surface_gravity=5.4994772446671565, stellar_age=3.476547411565939),
                     'q6': Star(spectral_type='T0.75', stellar_effective_temperature=5498.3614148481365, stellar_radius=27.411323630327598, stellar_mass=2.8987355387009845, stellar_luminosity=0.15054437214535266, stellar_surface_gravity=4.673929768880289, stellar_age=13.911242378642275),
                     'q7': -0.2885131815161717,
                     'q8': 6.997824094987192,
                     'q9': 4015.039007683925,
                     'q10': 'GJ 98426',
                     'q11': 7.94748344181802,
                     ...
                     'q12': Planet(planet_name='gam 8946 a', host_name='gam 8946', discovery_method='Astrometry', discovery_year=2017, controversial_flag=False, orbital_period=532.1753716513412, planet_radius=15.306329786133038, planet_mass=3488.6118777543497, semi_major_radius=53.38504687456268, eccentricity=0.035179151931687434, equilibrium_temperature=483.26971125011573, insolation_flux=956.6871163250947)}
