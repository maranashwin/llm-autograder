...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='F8.5VI', stellar_effective_temperature=5566.309992670854, stellar_radius=43.050323471911696, stellar_mass=2.5226437340187964, stellar_luminosity=0.1732995487191028, stellar_surface_gravity=2.5013838190339466, stellar_age=1.4971983712117822),
                     'q6': Star(spectral_type='G9.5V-', stellar_effective_temperature=2542.6425019628414, stellar_radius=11.33183185282571, stellar_mass=0.20919627815206887, stellar_luminosity=0.4525463857830247, stellar_surface_gravity=3.3364059578194714, stellar_age=5.068459154102157),
                     'q7': -0.38499192140638433,
                     'q8': 7.1312168561318785,
                     'q9': 10076.18770848658}
