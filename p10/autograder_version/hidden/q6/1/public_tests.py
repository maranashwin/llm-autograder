...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='A1VI', stellar_effective_temperature=4123.448572781808, stellar_radius=12.868622741321822, stellar_mass=3.378336131060916, stellar_luminosity=1.5135180597523312, stellar_surface_gravity=2.5225612594766376, stellar_age=0.6727759717953745),
                     'q6': Star(spectral_type='K6.75III', stellar_effective_temperature=4168.203297700285, stellar_radius=27.336616999966253, stellar_mass=2.5657872240523103, stellar_luminosity=-1.9609460631111788, stellar_surface_gravity=2.167546697312474, stellar_age=5.110096116347203)}
