...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='T5.75VI', stellar_effective_temperature=6026.261773421728, stellar_radius=39.39323834196666, stellar_mass=3.1488640232552383, stellar_luminosity=-0.1624178998712923, stellar_surface_gravity=3.248075150033336, stellar_age=2.629492712249111),
                     'q6': Star(spectral_type='L1.5III-T2III', stellar_effective_temperature=6209.1567846337375, stellar_radius=40.048152623621306, stellar_mass=3.8612016322194798, stellar_luminosity=0.898795982625217, stellar_surface_gravity=2.611739730160557, stellar_age=12.045891453791972)}
