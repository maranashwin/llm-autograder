...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='K0VI-K2.5III', stellar_effective_temperature=3196.6367487027137, stellar_radius=32.75586495673258, stellar_mass=1.595908470144451, stellar_luminosity=-0.04298729326500808, stellar_surface_gravity=5.764662398124397, stellar_age=4.256800992602233)}
