...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='K2.25VI', stellar_effective_temperature=6120.344082857146, stellar_radius=57.66972522836413, stellar_mass=0.9404428801263474, stellar_luminosity=-0.3537256602521744, stellar_surface_gravity=2.711954788559167, stellar_age=8.208372320871588),
                     'q6': Star(spectral_type='MII', stellar_effective_temperature=7570.365888108379, stellar_radius=33.678693801812656, stellar_mass=4.123761975351509, stellar_luminosity=None, stellar_surface_gravity=2.4565002136449774, stellar_age=11.167787701415683),
                     'q7': -0.18124482949714557}
