...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='F7VI', stellar_effective_temperature=5690.850626189913, stellar_radius=35.11380401116696, stellar_mass=5.170097806042644, stellar_luminosity=-0.38541876930790586, stellar_surface_gravity=2.7890688069449308, stellar_age=12.073117703345355),
                     'q6': Star(spectral_type='M7.5VI-V', stellar_effective_temperature=3825.3333959844113, stellar_radius=41.70495132130158, stellar_mass=4.9369767411337016, stellar_luminosity=-1.0979669393471043, stellar_surface_gravity=4.042655245481367, stellar_age=4.748399333101894),
                     'q7': -0.4692905914128013}
