...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_9.csvtxt',
                            'stars_8.csvtxt',
                            'stars_7.csvtxt',
                            'stars_6.csvtxt',
                            'stars_5.csv',
                     ...
                     'q2': ['data/stars_9.csvtxt',
                            ...
                            'data/stars_2.csv',
                            'data/stars_1.csv',
                            'data/planets_9.txtcsv',
                            'data/planets_8.txtcsv',
                            'data/planets_7.txtcsv',
                            'data/planets_6.txtcsv',
                            'data/planets_5.csv',
                            'data/planets_4.csv',
                            'data/planets_3.csv',
                            'data/planets_2.csv',
                            'data/planets_1.csv',
                            'data/mapping_9.csvcsv',
                            'data/mapping_8.csvcsv',
                            'data/mapping_7.csvcsv',
                            'data/mapping_6.csvcsv',
                            'data/mapping_5.json',
                            'data/mapping_4.json',
                            'data/mapping_3.json',
                            'data/mapping_2.json',
