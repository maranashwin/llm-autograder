...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='F5.25VI', stellar_effective_temperature=6582.828043264926, stellar_radius=54.32417857353301, stellar_mass=1.7707019174667271, stellar_luminosity=-0.0782877558309448, stellar_surface_gravity=3.4083120404855083, stellar_age=4.325171203155716),
                     'q6': Star(spectral_type='B5.75IV', stellar_effective_temperature=3449.9717119451943, stellar_radius=31.94917665970005, stellar_mass=2.68779373039066, stellar_luminosity=-0.9845901952447648, stellar_surface_gravity=2.2130498457797185, stellar_age=9.195864676574455),
                     'q7': -0.14191077331742843,
                     'q8': 7.019605584859861,
                     'q9': 3520.9171521965573,
                     'q10': 'tau 2171'}
