...
def get_expected_json():
    ...
    expected_json = {'q1': ['stars_5.csv',
                     ...
                     'q5': Star(spectral_type='B8.25II', stellar_effective_temperature=5913.552501555109, stellar_radius=45.776267372381135, stellar_mass=0.8755351925672739, stellar_luminosity=-1.4246410023933527, stellar_surface_gravity=0.7240452139845521, stellar_age=0.9289049502168742),
                     'q6': Star(spectral_type='FI/', stellar_effective_temperature=5974.6766865400405, stellar_radius=0.28241063169850733, stellar_mass=2.5208023558020116, stellar_luminosity=1.4180168808934344, stellar_surface_gravity=1.8757609043163754, stellar_age=6.271401390629221),
                     'q7': -0.5648500004841028,
                     'q8': 7.399871475912788,
                     'q10': 'BD 7152'}
