...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Williams, Scott and Lyons',
                            'League': 'Donaldson Inc (Seychelles)',
                            'Value': 354000,
                            'Wage': 22000,
                            'Attacking': 41.5,
                            'Movement': 40.3,
                     ...
                     'q3': 'Reunion',
                     'q4': 'CF',
                     'q5': ['Cummings, Rivas and Riley',
                            'Powers, Gonzalez and Thompson',
                            'Collier LLC',
                            'Johnson, Wagner and Cook',
                            'Brock-Myers',
                            'Thomas PLC',
                            'Torres, White and Thomas',
                            'Young PLC',
                            'Gilbert Inc',
                            'Kelley Group',
                            'Smith, Gonzales and Yates',
                            'Carroll-Gray',
                            'Collins LLC',
                            'Liverpool',
                            'Lewis, Simmons and Flores',
                            'Mann, Vargas and Smith',
                            'Sloan-Mckinney',
                            'Stephenson, Franklin and Thomas'],
                     'q6': {'Right': 500, 'Left': 500},
                     'q7': {'Right': 66.996, 'Left': 64.37}}
