...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Torres-Stevens',
                            'League': 'Robinson, Mcgee and Thomas (Uganda)',
                            'Value': 8900000,
                            'Wage': 41000,
                            'Attacking': 23.5,
                            'Movement': 39.0,
                     ...
                     'q2': {'ID': 861921,
                            ...
                            'Nationality': 'Bermuda',
                            'Team': 'Ortiz-Jones',
                            'League': 'Haley, Castillo and Monroe (Uganda)',
                            'Value': 245800000,
                            'Wage': 26000,
                            'Attacking': 60.4,
                            'Movement': 36.7,
                     ...
                     'q5': ['FC Barcelona',
                            'Martin Group',
                            'Nelson, Martin and Tapia',
                            'Knapp Inc',
                            'Cole Ltd',
                            'Murphy LLC',
                            'Ruiz, Brown and Martin',
                            'Wagner-Butler',
                            'Briggs LLC'],
                     'q6': {'Right': 479, 'Left': 521},
                     'q7': {'Right': 64.68684759916492, 'Left': 65.36660268714012}}
