...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Nationality': 'Cyprus',
                            'Team': 'FC Barcelona',
                            'League': 'Murphy-Malone (Northern Mariana Islands)',
                            'Value': 6800000,
                            'Wage': 90000,
                            'Attacking': 17.3,
                            'Movement': 24.8,
                     ...
                     'q5': ['FC Bayern München',
                            ...
                            'Obrien PLC',
                            'Bryant Ltd',
                            'Miller, Hopkins and Thornton',
                            'Schwartz Ltd',
                            'Wu, Chang and Christensen',
                            'King-Parks',
                            'Manchester United',
                            'Wilson PLC',
                            'Keller, Dean and King',
                            'Paris Saint Germain',
                            'Novak, Gordon and Stevenson'],
                     'q6': {'Foot A': 347, 'Foot C': 345, 'Foot B': 308},
                     'q7': {'Foot A': 66.30835734870317,
                            'Foot C': 65.17971014492754,
                            'Foot B': 66.0909090909091}}
