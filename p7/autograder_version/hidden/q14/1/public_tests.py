...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Stewart-Mckinney',
                            'League': 'Johnson Group (Vanuatu)',
                            'Value': 125600000,
                            'Wage': 371000,
                            'Attacking': 52.2,
                            'Movement': 93.1,
                     ...
                     'q3': 'Gibraltar',
                     'q4': 'CB',
                     'q5': ['Kaiser, Mccoy and Rodriguez',
                            'Nichols-Williams',
                            'Steele Group',
                            'Porter, Banks and Davis',
                            'Figueroa-Fox',
                            'Hughes-Brown',
                            'White-Hoover',
                            'Greene Inc',
                            'Parks, Doyle and Thompson',
                            'Woodward, Jackson and Marsh',
                            'Marshall-Barr',
                            'Nguyen, Taylor and Contreras',
                            'Davis Inc',
                            'Briggs, Hahn and Hall',
                            'Parker-Williams',
                            'Erickson-Chang'],
                     'q6': {'Right': 507, 'Left': 493},
                     'q7': {'Right': 68.33136094674556, 'Left': 63.249492900608516},
                     'q8': {'CB': 62,
                            'CDM': 89,
                            'RW': 70,
                            'CM': 61,
                            ...
                            'LM': 54,
                            'LB': 66},
                     'q9': {'CB': 29.919354838709676,
                            'CDM': 30.089887640449437,
                            'RW': 30.02857142857143,
                            'CM': 28.311475409836067,
                            'GK': 29.70967741935484,
                            'CF': 29.98181818181818,
                            'CAM': 30.95774647887324,
                            'RM': 28.625,
                            'LW': 27.864864864864863,
                            'RWB': 29.225806451612904,
                            'ST': 28.87323943661972,
                            'LWB': 29.34328358208955,
                            'RB': 30.1875,
                            'LM': 28.51851851851852,
                            'LB': 27.818181818181817},
                     'q10': {'CB': 180.8548387096774,
                             'CDM': 178.77528089887642,
                             'RW': 177.68571428571428,
                             'CM': 177.65573770491804,
                             'GK': 182.43548387096774,
                             'CF': 174.4,
                             'CAM': 183.40845070422534,
                             'RM': 179.30555555555554,
                             'LW': 177.97297297297297,
                             'RWB': 178.1290322580645,
                             'ST': 178.42253521126761,
                             'LWB': 183.26865671641792,
                             'RB': 176.046875,
                             'LM': 180.42592592592592,
                             'LB': 179.86363636363637},
                     'q11': {'CB': 35.89032258064516,
                             'CDM': 55.871910112359544,
                             'RW': 46.80857142857142,
                             'CM': 55.72622950819673,
                             'GK': 49.94354838709677,
                             'CF': 40.5218181818182,
                             'CAM': 64.16901408450704,
                             'RM': 46.554166666666674,
                             'LW': 50.04999999999999,
                             'RWB': 31.83870967741935,
                             'ST': 51.70704225352114,
                             'LWB': 48.47910447761194,
                             'RB': 45.50000000000001,
                             'LM': 47.51481481481481,
                             'LB': 47.12878787878787},
                     'q12': {'CB': 55.717741935483886,
                             'CDM': 54.15842696629211,
                             'RW': 57.171428571428564,
                             'CM': 49.932786885245896,
                             'GK': 57.11451612903226,
                             'CF': 49.145454545454555,
                             'CAM': 47.145070422535206,
                             'RM': 55.72083333333334,
                             'LW': 31.472972972972986,
                             'RWB': 50.377419354838715,
                             'ST': 40.180281690140866,
                             'LWB': 53.39402985074625,
                             'RB': 44.478124999999984,
                             'LM': 46.13703703703701,
                             'LB': 50.23484848484849},
                     'q13': 'CF',
                     'q14': 467465}
