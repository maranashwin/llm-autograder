...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Shepherd-Perez',
                            'League': 'Frederick Group (Honduras)',
                            'Value': 1900000,
                            'Wage': 75000,
                            'Attacking': 33.0,
                            'Movement': 71.1,
                     ...
                     'q2': {'ID': 815118,
                            ...
                            'Team': 'Price-Horn',
                            'League': 'Walker LLC (Saint Pierre and Miquelon)',
                            'Value': 248900000,
                            'Wage': 486000,
                            'Attacking': 88.3,
                            'Movement': 35.9,
                     ...
                     'q3': 'Niue',
                     'q4': 'RW',
                     'q5': ['Schneider, Smith and Bell',
                            'Padilla, Chung and Kelly',
                            'Phillips, Davila and Gonzalez',
                            'Armstrong-Riley',
                            'Jackson-Ritter',
                            'Madden, Gilbert and Powell',
                            'Mcfarland Inc',
                            'Rodriguez, Clark and Henderson',
                            'Paris Saint Germain',
                            'Hoffman-Jones',
                            'Johnson, Murray and Huff',
                            'Raymond Ltd',
                            'Nixon, Francis and Wright',
                            'Long, Fuentes and Jackson',
                            'Hill Ltd',
                            'Carney Group',
                            'Wiley Group',
                            'Howard Group',
                            'Pacheco, Hernandez and Gonzalez'],
                     'q6': {'Right': 973, 'Left': 1027},
                     'q7': {'Right': 67.74306269270298, 'Left': 64.12658227848101},
                     'q8': {'RW': 128,
                            'RB': 151,
                            'LWB': 133,
                            'LM': 133,
                            ...
                            'CF': 126},
                     'q9': {'RW': 28.828125,
                            'RB': 29.32450331125828,
                            'LWB': 29.977443609022558,
                            'LM': 29.857142857142858,
                            'CAM': 29.61111111111111,
                            'RM': 30.05185185185185,
                            'CM': 28.338461538461537,
                            'LW': 29.67883211678832,
                            'LB': 29.366666666666667,
                            'RWB': 29.826771653543307,
                            'CB': 28.651515151515152,
                            'GK': 29.575757575757574,
                            'CDM': 29.476190476190474,
                            'ST': 29.438356164383563,
                            'CF': 30.07936507936508},
                     'q10': {'RW': 178.4609375,
                             'RB': 180.1456953642384,
                             'LWB': 181.65413533834587,
                             'LM': 179.5187969924812,
                             'CAM': 178.3125,
                             'RM': 178.38518518518518,
                             'CM': 179.35384615384615,
                             'LW': 181.46715328467153,
                             'LB': 177.90833333333333,
                             'RWB': 179.2755905511811,
                             'CB': 178.50757575757575,
                             'GK': 181.03787878787878,
                             'CDM': 178.67460317460316,
                             'ST': 181.486301369863,
                             'CF': 178.23809523809524},
                     'q11': {'RW': 56.38828124999996,
                             'RB': 71.44238410596029,
                             'LWB': 30.649624060150376,
                             'LM': 34.755639097744364,
                             'CAM': 58.08680555555556,
                             'RM': 32.22666666666667,
                             'CM': 50.206153846153825,
                             'LW': 45.24890510948904,
                             'LB': 46.975833333333334,
                             'RWB': 41.43937007874016,
                             'CB': 42.850757575757584,
                             'GK': 31.328030303030303,
                             'CDM': 55.361904761904746,
                             'ST': 53.164383561643845,
                             'CF': 64.25396825396825},
                     'q12': {'RW': 65.94531249999999,
                             'RB': 32.04437086092717,
                             'LWB': 37.36616541353382,
                             'LM': 52.142857142857146,
                             'CAM': 43.057638888888874,
                             'RM': 50.84740740740741,
                             'CM': 52.16461538461537,
                             'LW': 49.52773722627739,
                             'LB': 32.63166666666666,
                             'RWB': 60.3212598425197,
                             'CB': 43.458333333333336,
                             'GK': 70.19621212121214,
                             'CDM': 52.29365079365079,
                             'ST': 40.093835616438376,
                             'CF': 58.73809523809524},
                     'q13': 'LWB',
                     'q14': 240612,
                     'q15': {'ID': 360518,
                             'Name': 'J. Ward',
                             ...
                             'Nationality': 'Turkey',
                             'Team': 'Liverpool',
                             'League': 'Williams, Gibbs and Johnson (Honduras)',
                             'Value': 152600000,
                             'Wage': 423000,
                             'Attacking': 25.4,
                             'Movement': 52.3,
