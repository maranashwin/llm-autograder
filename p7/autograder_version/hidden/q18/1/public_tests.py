...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Nationality': 'Belgium',
                            'Team': 'Hodges-Moore',
                            'League': 'Bridges, Watts and Mejia (Brazil)',
                            'Value': 890000,
                            'Wage': 61000,
                            'Attacking': 36.3,
                            'Movement': 47.4,
                     ...
                     'q2': {'ID': 641694,
                            ...
                            'Age': 26,
                            'Nationality': 'Canada',
                            'Team': 'Jackson-Rowland',
                            'League': 'Peterson LLC (Svalbard & Jan Mayen Islands)',
                            'Value': 249700000,
                            'Wage': 487000,
                            'Attacking': 33.6,
                            'Movement': 83.9,
                     ...
                     'q5': ['Brown-Hunter',
                            ...
                            'Dominguez-Klein',
                            'Shelton-Gonzalez',
                            'Wilson, Roman and Phillips',
                            'Clark and Sons',
                            'Stone-Price',
                            'Simon, Robinson and Mccarthy',
                            'Ellis PLC',
                            'Ramirez-Collins',
                            'Caldwell, Williamson and Reyes',
                            'Johnson and Sons',
                            'Thompson, Davidson and Valencia',
                            'Paris Saint Germain',
                            'Burke-Swanson',
                            'Manchester United',
                            'Brown, Holloway and Nelson',
                            'Franklin, Williams and Contreras'],
                     'q6': {'Left': 1011, 'Right': 989},
                     'q7': {'Left': 66.87636003956479, 'Right': 65.1314459049545},
                     'q8': {'LW': 123,
                            'CM': 142,
                            'LWB': 113,
                            'CAM': 146,
                            ...
                            'RWB': 144,
                            'RM': 133},
                     'q9': {'LW': 29.56910569105691,
                            'CM': 29.37323943661972,
                            'LWB': 30.15929203539823,
                            'CAM': 29.726027397260275,
                            'GK': 28.272727272727273,
                            'LB': 30.804347826086957,
                            'ST': 29.055555555555557,
                            'RW': 28.736842105263158,
                            'LM': 27.923076923076923,
                            'CF': 28.420289855072465,
                            'RB': 30.07936507936508,
                            'CDM': 28.54032258064516,
                            'CB': 29.85496183206107,
                            'RWB': 29.23611111111111,
                            'RM': 29.157894736842106},
                     'q10': {'LW': 179.52032520325204,
                             'CM': 178.40845070422534,
                             'LWB': 180.91150442477877,
                             'CAM': 179.75342465753425,
                             'GK': 181.2479338842975,
                             'LB': 178.52898550724638,
                             'ST': 178.22222222222223,
                             'RW': 181.2171052631579,
                             'LM': 179.3846153846154,
                             'CF': 180.231884057971,
                             'RB': 181.96031746031747,
                             'CDM': 177.98387096774192,
                             'CB': 180.53435114503816,
                             'RWB': 181.28472222222223,
                             'RM': 180.18796992481202},
                     'q11': {'LW': 64.65365853658534,
                             'CM': 41.993661971831,
                             'LWB': 42.27610619469024,
                             'CAM': 56.00068493150682,
                             'GK': 67.63471074380165,
                             'LB': 28.371739130434783,
                             'ST': 61.24365079365082,
                             'RW': 30.63092105263159,
                             'LM': 64.31748251748252,
                             'CF': 47.44202898550726,
                             'RB': 48.38571428571431,
                             'CDM': 47.59032258064515,
                             'CB': 26.334351145038163,
                             'RWB': 45.84097222222222,
                             'RM': 42.4045112781955},
                     'q12': {'LW': 46.70650406504067,
                             'CM': 59.71760563380281,
                             'LWB': 64.59203539823011,
                             'CAM': 62.89931506849313,
                             'GK': 60.85454545454546,
                             'LB': 55.383333333333354,
                             'ST': 45.16984126984127,
                             'RW': 55.50657894736843,
                             'LM': 51.55384615384615,
                             'CF': 47.484057971014494,
                             'RB': 29.409523809523815,
                             'CDM': 55.61854838709678,
                             'CB': 31.841221374045816,
                             'RWB': 44.83402777777778,
                             'RM': 42.83834586466165},
                     'q13': 'LM',
                     'q14': 975085,
                     'q15': {'ID': 436911,
                             ...
                             'Team': 'Liverpool',
                             'League': 'Jones-Trevino (Saint Barthelemy)',
                             'Value': 134100000,
                             'Wage': 357000,
                             'Attacking': 49.6,
                             'Movement': 71.1,
