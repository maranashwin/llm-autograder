...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Hart-King',
                            'League': 'Saunders, Dixon and Willis (North Macedonia)',
                            'Value': 500,
                            'Wage': 0,
                            'Attacking': 43.6,
                            'Movement': 29.2,
                     ...
                     'q2': {'ID': 164366,
                            ...
                            'Team': 'Evans, Webster and Young',
                            'League': 'Graham-Harper (Namibia)',
                            'Value': 249300000,
                            'Wage': 450000,
                            'Attacking': 43.7,
                            'Movement': 81.0,
                     ...
                     'q5': ['Black Group',
                            'Nelson-Freeman',
                            'Pearson, Rivas and Taylor',
                            'Young, Moore and Richardson',
                            'Sandoval Ltd',
                            'Bennett, Welch and Brown',
                            'Liverpool',
                            'Smith, Beasley and Cox',
                            'Wallace LLC',
                            'FC Bayern München',
                            'Brown, Mcintosh and Jones',
                            'Mason-Smith',
                            'Paris Saint Germain',
                            'Hernandez-Patterson',
                            'Lewis LLC'],
                     'q6': {'Right': 487, 'Left': 513},
                     'q7': {'Right': 66.95893223819301, 'Left': 64.32358674463937},
                     'q8': {'GK': 66,
                            'LW': 58,
                            'LM': 70,
                            'RM': 58,
                            ...
                            'LB': 74,
                            'LWB': 77},
                     'q9': {'GK': 27.939393939393938,
                            'LW': 28.96551724137931,
                            'LM': 30.214285714285715,
                            'RM': 30.103448275862068,
                            'CF': 28.98148148148148,
                            'RWB': 29.838709677419356,
                            'CDM': 28.208333333333332,
                            'CM': 27.954545454545453,
                            'CAM': 28.21311475409836,
                            'CB': 29.43076923076923,
                            'ST': 30.112676056338028,
                            'RW': 29.845238095238095,
                            'RB': 28.822580645161292,
                            'LB': 28.35135135135135,
                            'LWB': 28.857142857142858},
                     'q10': {'GK': 179.9090909090909,
                             'LW': 180.5344827586207,
                             'LM': 178.21428571428572,
                             'RM': 177.3793103448276,
                             'CF': 176.74074074074073,
                             'RWB': 180.5,
                             'CDM': 180.26388888888889,
                             'CM': 177.13636363636363,
                             'CAM': 179.63934426229508,
                             'CB': 178.06153846153848,
                             'ST': 180.22535211267606,
                             'RW': 179.91666666666666,
                             'RB': 178.69354838709677,
                             'LB': 180.2027027027027,
                             'LWB': 182.6883116883117},
                     'q11': {'CAM': 0.0,
                             'CB': 1.0,
                             'CDM': 2.0,
                             'CF': 3.0,
