...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Haas, Knight and Craig',
                            'League': 'Thompson PLC (Sierra Leone)',
                            'Value': 862000,
                            'Wage': 59000,
                            'Attacking': 16.9,
                            'Movement': 71.3,
                     ...
                     'q5': ['Hernandez Inc',
                            'Berger Group',
                            'Liverpool',
                            'Little, Craig and Wong',
                            'Cooper, Nolan and Villegas',
                            'Levine-Montoya',
                            'Moore LLC',
                            'Herrera Ltd',
                            'Barton-Vega',
                            'Williams, Anthony and Bowen',
                            'Harmon and Sons',
                            'Green-Brooks',
                            'Lawson Ltd',
                            'Henderson Inc',
                            'Smith, Williamson and Norman',
                            'Cunningham-Camacho',
                            'Silva-Torres',
                            'Herrera PLC'],
                     'q6': {'Left': 481, 'Right': 519},
                     'q7': {'Left': 66.15800415800416, 'Right': 67.53757225433526},
                     'q8': {'LM': 57,
                            'LB': 70,
                            'ST': 76,
                            'CDM': 78,
                            ...
                            'RB': 55,
                            'CB': 57},
                     'q9': {'LM': 28.87719298245614,
                            'LB': 29.442857142857143,
                            'ST': 29.38157894736842,
                            'CDM': 29.666666666666668,
                            'CF': 28.68831168831169,
                            'GK': 30.561643835616437,
                            'RWB': 29.553846153846155,
                            'RW': 28.746031746031747,
                            'LW': 30.078125,
                            'RM': 29.256756756756758,
                            'LWB': 28.071428571428573,
                            'CAM': 28.2,
                            'CM': 29.0,
                            'RB': 30.345454545454544,
                            'CB': 30.350877192982455},
                     'q10': {'LM': 180.01754385964912,
                             'LB': 177.38571428571427,
                             'ST': 178.51315789473685,
                             'CDM': 180.55128205128204,
                             'CF': 176.80519480519482,
                             'GK': 177.0,
                             'RWB': 182.23076923076923,
                             'RW': 174.984126984127,
                             'LW': 180.171875,
                             'RM': 177.64864864864865,
                             'LWB': 179.02857142857144,
                             'CAM': 179.3846153846154,
                             'CM': 178.07142857142858,
                             'RB': 180.1818181818182,
                             'CB': 178.21052631578948},
                     'q11': {'CAM': 0.0,
                             'CB': 1.0,
                             'CDM': 2.0,
                             'CF': 3.0,
