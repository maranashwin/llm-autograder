...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Age': 25,
                            'Nationality': 'Comoros',
                            'Team': 'Young-Dominguez',
                            'League': 'Parker-Gibson (Cape Verde)',
                            'Value': 6600000,
                            'Wage': 91000,
                            'Attacking': 83.0,
                            'Movement': 53.9,
                     ...
                     'q3': 'Comoros',
                     'q4': 'RM',
                     'q5': ['Rivera, Lambert and Ramirez',
                            'Reyes, Gray and Jenkins',
                            'Frye, Gates and Reyes',
                            'Barrett, Harper and Nguyen',
                            'Davis-Franklin',
                            'Petersen-Gomez',
                            'Durham, Villa and Hudson',
                            'Miller Ltd',
                            'Miller, Parks and Thomas',
                            'FC Bayern München',
                            'Leach LLC',
                            'Wilson Inc',
                            'Galvan, Williams and Joyce',
                            'Romero Ltd',
                            'Fitzgerald and Sons'],
                     'q6': {'Left': 492, 'Right': 508},
                     'q7': {'Left': 67.76219512195122, 'Right': 62.89370078740158},
                     'q8': {'LW': 57,
                            'CF': 65,
                            'RM': 79,
                            'CDM': 76,
                            ...
                            'LB': 64,
                            'RB': 62},
                     'q9': {'LW': 30.736842105263158,
                            'CF': 30.753846153846155,
                            'RM': 29.873417721518987,
                            'CDM': 28.75,
                            'RW': 29.017543859649123,
                            'LM': 27.74074074074074,
                            'RWB': 30.493506493506494,
                            'CB': 29.691176470588236,
                            'ST': 28.506849315068493,
                            'LWB': 29.765625,
                            'GK': 28.931506849315067,
                            'CAM': 30.9,
                            'CM': 29.737704918032787,
                            'LB': 30.765625,
                            'RB': 30.29032258064516},
                     'q10': {'LW': 177.140350877193,
                             'CF': 177.52307692307693,
                             'RM': 184.1139240506329,
                             'CDM': 173.0,
                             'RW': 180.68421052631578,
                             'LM': 180.7962962962963,
                             'RWB': 180.25974025974025,
                             'CB': 182.3235294117647,
                             'ST': 177.2054794520548,
                             'LWB': 178.203125,
                             'GK': 181.2054794520548,
                             'CAM': 181.28571428571428,
                             'CM': 181.01639344262296,
                             'LB': 176.125,
                             'RB': 180.41935483870967},
                     'q11': {'LW': 45.50350877192984,
                             'CF': 51.09538461538462,
                             'RM': 31.10506329113924,
                             'CDM': 55.124999999999986,
                             'RW': 63.15438596491231,
                             'LM': 64.65555555555558,
                             'RWB': 65.81298701298701,
                             'CB': 48.23382352941177,
                             'ST': 28.978082191780825,
                             'LWB': 52.370312500000004,
                             'GK': 55.80821917808218,
                             'CAM': 41.27571428571427,
                             'CM': 39.429508196721315,
                             'LB': 37.65625000000001,
                             'RB': 51.76774193548389},
                     'q12': {'LW': 50.878947368421045,
                             'CF': 63.2676923076923,
                             'RM': 63.56835443037976,
                             'CDM': 51.10394736842105,
                             'RW': 34.04035087719297,
                             'LM': 40.49444444444445,
                             'RWB': 67.48441558441557,
                             'CB': 53.76323529411766,
                             'ST': 43.15479452054794,
                             'LWB': 34.842187499999994,
                             'GK': 60.346575342465755,
                             'CAM': 47.115714285714276,
                             'CM': 44.67704918032786,
                             'LB': 69.2703125,
                             'RB': 38.012903225806454},
                     'q13': 'ST',
                     'q14': 328517,
                     'q15': {'ID': 524479,
                             'Name': 'Nguyen',
                             ...
                             'Team': 'Liverpool',
                             'League': 'Carter, Jacobson and Parker (Sierra Leone)',
                             'Value': 173600000,
                             'Wage': 444000,
                             'Attacking': 82.6,
                             'Movement': 19.0,
