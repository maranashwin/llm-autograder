...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Tate-Medina',
                            'League': 'Huber-Mcdonald (Argentina)',
                            'Value': 977000,
                            'Wage': 0,
                            'Attacking': 51.2,
                            'Movement': 24.1,
                     ...
                     'q2': {'ID': 509589,
                            ...
                            'Team': 'Bennett, Stephens and English',
                            'League': 'Cain, Booth and Gibson (Palestinian Territory)',
                            'Value': 245600000,
                            'Wage': 44000,
                            'Attacking': 40.5,
                            'Movement': 56.9,
                            ...
                            'Height': 182,
                            'Preferred foot': 'Left'},
                     'q3': 'United Arab Emirates',
                     'q4': 'LW',
                     'q5': ['FC Bayern München',
                            'Wagner, Dawson and Cross',
                            'Christian, Cole and Armstrong',
                            'David, Barnes and Gardner'],
                     'q6': {'Left': 487, 'Right': 513},
                     'q7': {'Left': 66.53388090349075, 'Right': 67.1364522417154},
                     'q8': {'CB': 87,
                            'LM': 61,
                            'LB': 70,
                            'CM': 75,
                            ...
                            'CF': 70,
                            'ST': 56},
                     'q9': {'CB': 29.850574712643677,
                            'LM': 29.131147540983605,
                            'LB': 30.02857142857143,
                            'CM': 31.14666666666667,
                            'CDM': 29.058823529411764,
                            'RM': 29.953125,
                            'RWB': 27.77027027027027,
                            'GK': 29.942857142857143,
                            'CAM': 29.333333333333332,
                            'LWB': 30.949152542372882,
                            'LW': 29.328767123287673,
                            'RW': 29.693548387096776,
                            'RB': 30.951612903225808,
                            'CF': 29.085714285714285,
                            'ST': 30.196428571428573},
                     'q10': {'CB': 182.4367816091954,
                             'LM': 181.19672131147541,
                             'LB': 181.07142857142858,
                             'CM': 177.49333333333334,
                             'CDM': 183.7058823529412,
                             'RM': 173.34375,
                             'RWB': 181.33783783783784,
                             'GK': 182.5857142857143,
                             'CAM': 182.86363636363637,
                             'LWB': 179.864406779661,
                             'LW': 181.76712328767124,
                             'RW': 182.93548387096774,
                             'RB': 179.5483870967742,
                             'CF': 178.07142857142858,
                             'ST': 179.73214285714286},
                     'q11': {'CB': 58.227586206896554,
                             'LM': 60.865573770491814,
                             'LB': 55.63571428571427,
                             'CM': 56.40000000000001,
                             'CDM': 53.04509803921569,
                             'RM': 53.86718750000001,
                             'RWB': 54.851351351351354,
                             'GK': 53.02857142857143,
                             'CAM': 56.99090909090909,
                             'LWB': 50.82203389830508,
                             'LW': 55.390410958904106,
                             'RW': 55.89999999999999,
                             'RB': 54.177419354838705,
                             'CF': 58.91857142857143,
                             'ST': 54.832142857142856},
                     'q12': {'CB': 46.577011494252865,
                             'LM': 45.395081967213116,
                             'LB': 40.405714285714296,
                             'CM': 46.1906666666667,
                             'CDM': 47.325490196078405,
                             'RM': 45.18906250000001,
                             'RWB': 45.17297297297298,
                             'GK': 42.69285714285714,
                             'CAM': 43.175757575757565,
                             'LWB': 47.01525423728813,
                             'LW': 44.62328767123288,
                             'RW': 47.43387096774193,
                             'RB': 42.41612903225807,
                             'CF': 46.42142857142857,
                             'ST': 47.55357142857144},
                     'q13': 'RM',
                     'q14': 901808,
                     'q15': {'ID': 790252,
                             'Name': 'Adrian Jr.',
