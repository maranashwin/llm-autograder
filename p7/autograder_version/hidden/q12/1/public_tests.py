...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q2': {'ID': 723823,
                            ...
                            'Team': 'Gallagher-Mack',
                            'League': 'Hayes, Phelps and Taylor (Australia)',
                            'Value': 249700000,
                            'Wage': 537000,
                            'Attacking': 83.1,
                            'Movement': 31.7,
                     ...
                     'q3': 'Liechtenstein',
                     'q4': 'LW',
                     'q5': ['Hanson, Harrison and Colon',
                            'Jefferson-Burgess',
                            'Simpson, Fritz and Love',
                            'Jenkins, Barr and Black',
                            'Smith, Wilson and Sandoval',
                            'Garcia, Buckley and Miller',
                            'Stewart, Moreno and Campbell',
                            'Marquez-Strickland',
                            'Robinson, Brown and Knight',
                            'Williams, Nelson and Watts',
                            'Porter, Griffin and Rowland',
                            'Contreras-Robles',
                            'FC Barcelona',
                            'Walker-Vaughn'],
                     'q6': {'Left': 485, 'Right': 515},
                     'q7': {'Left': 69.26185567010309, 'Right': 66.6116504854369},
                     'q8': {'LW': 65,
                            'RW': 73,
                            'RWB': 62,
                            'RM': 61,
                            ...
                            'CM': 64},
                     'q9': {'LW': 29.4,
                            'RW': 30.054794520547944,
                            'RWB': 28.758064516129032,
                            'RM': 28.278688524590162,
                            'LWB': 29.271604938271604,
                            'CF': 29.741935483870968,
                            'CDM': 28.791044776119403,
                            'CB': 30.370967741935484,
                            'GK': 28.507246376811594,
                            'CAM': 28.91358024691358,
                            'ST': 31.210526315789473,
                            'LB': 30.352941176470587,
                            'RB': 30.686567164179106,
                            'LM': 29.9672131147541,
                            'CM': 28.1875},
                     'q10': {'LW': 180.69230769230768,
                             'RW': 184.7123287671233,
                             'RWB': 177.29032258064515,
                             'RM': 181.78688524590163,
                             'LWB': 179.6172839506173,
                             'CF': 175.24193548387098,
                             'CDM': 178.08955223880596,
                             'CB': 183.38709677419354,
                             'GK': 182.231884057971,
                             'CAM': 180.25925925925927,
                             'ST': 181.9298245614035,
                             'LB': 179.9558823529412,
                             'RB': 179.76119402985074,
                             'LM': 178.63934426229508,
                             'CM': 179.203125},
                     'q11': {'CAM': 0.0,
                             'CB': 1.0,
                             'CDM': 2.0,
