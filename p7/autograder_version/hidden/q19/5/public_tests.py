...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Age': 28,
                            'Nationality': 'Malta',
                            'Team': 'Carpenter, Boyer and Payne',
                            'League': 'Morrison Ltd (Bulgaria)',
                            'Value': 946000,
                            'Wage': 72000,
                            'Attacking': 53.1,
                            'Movement': 55.5,
                     ...
                     'q2': {'ID': 614497,
                            ...
                            'Team': 'Walker, Scott and Garcia',
                            'League': 'Frazier Inc (Romania)',
                            'Value': 249500000,
                            'Wage': 0,
                            'Attacking': 61.5,
                            'Movement': 51.0,
                     ...
                     'q3': 'Saint Barthelemy',
                     'q4': 'GK',
                     'q5': ['Paris Saint Germain',
                            'Mcclain, Khan and Pennington',
                            'Rogers Inc',
                            'Werner Group',
                            'Rivera and Sons'],
                     'q6': {'Right': 502, 'Left': 498},
                     'q7': {'Right': 63.754980079681275, 'Left': 63.78112449799197},
                     'q8': {'RWB': 65,
                            'ST': 66,
                            'RW': 71,
                            'CM': 61,
                            ...
                            'LM': 51,
                            'LB': 59},
                     'q9': {'RWB': 31.046153846153846,
                            'ST': 27.818181818181817,
                            'RW': 29.04225352112676,
                            'CM': 28.16393442622951,
                            'RM': 28.057971014492754,
                            'CF': 29.76388888888889,
                            'LWB': 28.54054054054054,
                            'LW': 29.884057971014492,
                            'CDM': 29.0,
                            'CB': 29.904109589041095,
                            'GK': 30.017241379310345,
                            'CAM': 28.463414634146343,
                            'RB': 29.396825396825395,
                            'LM': 28.725490196078432,
                            'LB': 29.983050847457626},
                     'q10': {'RWB': 179.6769230769231,
                             'ST': 180.16666666666666,
                             'RW': 182.7605633802817,
                             'CM': 180.2295081967213,
                             'RM': 181.33333333333334,
                             'CF': 182.06944444444446,
                             'LWB': 180.1081081081081,
                             'LW': 180.1159420289855,
                             'CDM': 180.044776119403,
                             'CB': 181.8082191780822,
                             'GK': 178.5344827586207,
                             'CAM': 179.6219512195122,
                             'RB': 180.0,
                             'LM': 179.11764705882354,
                             'LB': 175.83050847457628},
                     'q11': {'RWB': 49.31538461538462,
                             'ST': 50.887878787878776,
                             'RW': 46.48873239436621,
                             'CM': 52.42459016393444,
                             'RM': 49.684057971014475,
                             'CF': 51.75277777777777,
                             'LWB': 50.83243243243245,
                             'LW': 47.45362318840579,
                             'CDM': 48.76567164179104,
                             'CB': 46.741095890410975,
                             'GK': 46.16724137931034,
                             'CAM': 47.53658536585366,
                             'RB': 49.43809523809524,
                             'LM': 49.36078431372548,
                             'LB': 48.14745762711864},
                     'q12': {'RWB': 46.76615384615385,
                             'ST': 50.7939393939394,
                             'RW': 50.250704225352116,
                             'CM': 47.12295081967213,
                             'RM': 49.31014492753623,
                             'CF': 48.06805555555555,
                             'LWB': 45.628378378378386,
                             'LW': 47.80434782608695,
                             'CDM': 49.24179104477612,
                             'CB': 48.45616438356164,
                             'GK': 49.39482758620688,
                             'CAM': 49.05121951219513,
                             'RB': 49.27460317460317,
                             'LM': 51.77647058823529,
                             'LB': 47.555932203389816},
                     'q13': 'GK',
                     'q14': 238563,
                     'q15': {'ID': 830547,
                             'Name': 'Cantrell',
                     ...
                     'q17': {'ST': 'David Jr.',
                             ...
                             'RM': 'J. Fleming'},
                     'q18': 179176500,
                     'q19': {'Paris Saint Germain': 50.699999999999996,
                             'Mcclain, Khan and Pennington': 46.00714285714286,
                             'Rogers Inc': 59.08181818181817,
                             'Werner Group': 51.19,
                             'Rivera and Sons': 42.266666666666666}}
