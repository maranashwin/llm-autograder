...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q5': ['Johnson-Turner',
                            'Savage-Lewis',
                            'Ellis, Cruz and Johnson',
                            'Vang, Morris and Nelson',
                            'Manchester United',
                            'Perez, Ruiz and Lopez',
                            'Lopez PLC',
                            'Huber-Olson',
                            'Liverpool',
                            'FC Barcelona',
                            'Atkins, Jimenez and Rodriguez',
                            'Jones LLC',
                            'Henry PLC',
                            'Gillespie LLC',
                            'Fox, Baker and Robles',
                            'Scott, Nash and Roth',
                            'Rodriguez-Gonzalez',
                            'Clark and Sons'],
                     'q6': {'Right': 469, 'Left': 531},
                     'q7': {'Right': 66.13006396588486, 'Left': 64.2316384180791},
                     'q8': {'RW': 90,
                            'CDM': 62,
                            'GK': 67,
                            'LWB': 70,
                            ...
                            'CAM': 67,
                            'CF': 58},
                     'q9': {'RW': 27.38888888888889,
                            'CDM': 27.483870967741936,
                            'GK': 28.19402985074627,
                            'LWB': 29.728571428571428,
                            'LM': 29.682539682539684,
                            'RM': 29.785714285714285,
                            'RWB': 30.42622950819672,
                            'CB': 30.029411764705884,
                            'CM': 29.933333333333334,
                            'RB': 29.686567164179106,
                            'ST': 29.575757575757574,
                            'LW': 30.22641509433962,
                            'LB': 28.857142857142858,
                            'CAM': 29.238805970149254,
                            'CF': 28.896551724137932},
                     'q10': {'RW': 180.5222222222222,
                             'CDM': 179.61290322580646,
                             'GK': 177.40298507462686,
                             'LWB': 179.21428571428572,
                             'LM': 179.28571428571428,
                             'RM': 178.08928571428572,
                             'RWB': 178.63934426229508,
                             'CB': 177.77941176470588,
                             'CM': 178.68,
                             'RB': 174.97014925373134,
                             'ST': 179.07575757575756,
                             'LW': 180.60377358490567,
                             'LB': 182.6883116883117,
                             'CAM': 179.02985074626866,
                             'CF': 177.58620689655172},
                     'q11': {'RW': 53.91777777777778,
                             'CDM': 39.68225806451612,
                             'GK': 46.319402985074625,
                             'LWB': 40.714285714285694,
                             'LM': 58.03968253968256,
                             'RM': 36.92321428571429,
                             'RWB': 42.022950819672126,
                             'CB': 58.8941176470588,
                             'CM': 53.833333333333336,
                             'RB': 52.82388059701493,
                             'ST': 30.95606060606061,
                             'LW': 52.72452830188677,
                             'LB': 36.52857142857144,
                             'CAM': 45.42238805970149,
                             'CF': 54.774137931034474},
                     'q12': {'RW': 47.964444444444446,
                             'CDM': 57.80967741935484,
                             'GK': 58.213432835820896,
                             'LWB': 70.3857142857143,
                             'LM': 49.60476190476191,
                             'RM': 50.13214285714288,
                             'RWB': 36.71475409836068,
                             'CB': 39.236764705882365,
                             'CM': 53.198666666666675,
                             'RB': 42.73880597014926,
                             'ST': 48.70606060606061,
                             'LW': 42.21698113207546,
                             'LB': 47.02857142857142,
                             'CAM': 49.247761194029856,
                             'CF': 47.103448275862064},
                     'q13': 'CDM',
                     'q14': 895697,
                     'q15': {'ID': 814026,
                             'Name': 'Angel Haas',
                     ...
                     'q17': {'CDM': 'C. Choi',
                             ...
                             'LWB': 'Robert Haney'},
                     'q18': 111790000,
                     'q19': {'Johnson-Turner': 53.55454545454547,
                             'Savage-Lewis': 42.949999999999996,
                             'Ellis, Cruz and Johnson': 47.62307692307692,
                             'Vang, Morris and Nelson': 47.45000000000001,
                             'Manchester United': 48.45,
                             'Perez, Ruiz and Lopez': 50.25,
                             'Lopez PLC': 43.779999999999994,
                             'Huber-Olson': 38.9,
                             'Liverpool': 42.72727272727273,
                             'FC Barcelona': 48.98181818181819,
                             'Atkins, Jimenez and Rodriguez': 44.945454545454545,
                             'Jones LLC': 46.577777777777776,
                             'Henry PLC': 50.12727272727272,
                             'Gillespie LLC': 42.21666666666666,
                             'Fox, Baker and Robles': 50.56,
                             'Scott, Nash and Roth': 44.93333333333334,
                             'Rodriguez-Gonzalez': 49.527272727272724,
                             'Clark and Sons': 48.47}}
