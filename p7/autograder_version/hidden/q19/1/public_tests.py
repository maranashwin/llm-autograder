...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Miller LLC',
                            'League': 'Patel, Giles and Watson (Palestinian Territory)',
                            'Value': 403000,
                            'Wage': 24000,
                            'Attacking': 65.7,
                            'Movement': 54.7,
                     ...
                     'q2': {'ID': 502808,
                            ...
                            'Nationality': 'Japan',
                            'Team': 'Lewis LLC',
                            'League': 'Harris-Simon (Syrian Arab Republic)',
                            'Value': 247200000,
                            'Wage': 481000,
                            'Attacking': 42.6,
                            'Movement': 91.1,
                     ...
                     'q3': 'Palestinian Territory',
                     'q4': 'RWB',
                     'q5': ['Wilson Ltd',
                            'Paris Saint Germain',
                            'Garrett, Hunter and Gordon',
                            'Wilson Inc',
                            'Snyder-Miller',
                            'Logan, Wilson and Pearson',
                            'Francis, Shaw and Edwards',
                            'Liverpool',
                            'Chapman, Hart and Barnett',
                            'Holmes, Schroeder and Adams',
                            'Greer Group',
                            'Evans Group',
                            'Fowler, Odonnell and Miller',
                            'Brown-Nelson',
                            'Sanchez, Porter and Martin',
                            'Booth and Sons',
                            'Harris PLC'],
                     'q6': {'Left': 500, 'Right': 500},
                     'q7': {'Left': 67.154, 'Right': 67.27},
                     'q8': {'CDM': 73,
                            'RWB': 55,
                            'ST': 65,
                            'RB': 69,
                            ...
                            'CB': 69,
                            'CF': 56},
                     'q9': {'CDM': 29.835616438356166,
                            'RWB': 30.836363636363636,
                            'ST': 31.49230769230769,
                            'RB': 29.666666666666668,
                            'LW': 28.43661971830986,
                            'RM': 28.15625,
                            'RW': 30.983606557377048,
                            'CAM': 28.18918918918919,
                            'LWB': 29.62162162162162,
                            'GK': 31.214285714285715,
                            'CM': 28.0,
                            'LB': 29.390625,
                            'LM': 28.295774647887324,
                            'CB': 30.202898550724637,
                            'CF': 31.196428571428573},
                     'q10': {'CDM': 184.2054794520548,
                             'RWB': 179.16363636363636,
                             'ST': 181.1846153846154,
                             'RB': 185.07246376811594,
                             'LW': 178.95774647887325,
                             'RM': 180.25,
                             'RW': 176.68852459016392,
                             'CAM': 179.36486486486487,
                             'LWB': 179.8108108108108,
                             'GK': 180.89285714285714,
                             'CM': 181.94871794871796,
                             'LB': 180.0,
                             'LM': 177.69014084507043,
                             'CB': 177.65217391304347,
                             'CF': 178.48214285714286},
                     'q11': {'CDM': 59.378082191780805,
                             'RWB': 49.23454545454544,
                             'ST': 41.55230769230771,
                             'RB': 62.62898550724637,
                             'LW': 39.870422535211276,
                             'RM': 49.18281249999998,
                             'RW': 43.175409836065576,
                             'CAM': 47.38918918918919,
                             'LWB': 53.96216216216217,
                             'GK': 48.63214285714286,
                             'CM': 35.20641025641026,
                             'LB': 50.30000000000001,
                             'LM': 48.55211267605634,
                             'CB': 43.92753623188406,
                             'CF': 57.56249999999999},
                     'q12': {'CDM': 45.112328767123294,
                             'RWB': 59.218181818181826,
                             'ST': 46.623076923076916,
                             'RB': 48.07101449275362,
                             'LW': 64.56901408450702,
                             'RM': 55.934374999999996,
                             'RW': 68.16885245901639,
                             'CAM': 61.04594594594594,
                             'LWB': 48.73783783783785,
                             'GK': 39.00178571428571,
                             'CM': 54.87692307692306,
                             'LB': 65.76093750000001,
                             'LM': 25.625352112676044,
                             'CB': 48.25652173913045,
                             'CF': 49.85714285714283},
                     'q13': 'LW',
                     'q14': 625615,
                     'q15': {'ID': 853294,
                             'Name': 'Hart',
                     ...
                     'q17': {'RWB': 'E. Mays',
                             ...
                             'CAM': 'D. Nguyen',
                             'CDM': 'Bailey',
                             'LB': 'Christopher Blackburn',
                             'CB': 'D. Rodriguez',
                             'LWB': 'C. Holmes'},
                     'q18': 1164750,
                     'q19': {'Wilson Ltd': 51.21999999999999,
                             'Paris Saint Germain': 49.03333333333333,
                             'Garrett, Hunter and Gordon': 56.06666666666668,
                             'Wilson Inc': 51.91818181818183,
                             'Snyder-Miller': 54.52307692307693,
                             'Logan, Wilson and Pearson': 51.94166666666666,
                             'Francis, Shaw and Edwards': 55.19999999999999,
                             'Liverpool': 52.290000000000006,
                             'Chapman, Hart and Barnett': 51.05384615384616,
                             'Holmes, Schroeder and Adams': 46.15,
                             'Greer Group': 51.14545454545455,
                             'Evans Group': 51.76666666666666,
                             'Fowler, Odonnell and Miller': 53.527272727272724,
                             'Brown-Nelson': 47.760000000000005,
                             'Sanchez, Porter and Martin': 47.7,
                             'Booth and Sons': 52.50833333333333,
                             'Harris PLC': 53.5625}}
