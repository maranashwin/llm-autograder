...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q2': {'ID': 863131,
                            ...
                            'Team': 'Romero, Hoffman and Hall',
                            'League': 'King-Miller (Micronesia)',
                            'Value': 249900000,
                            'Wage': 494000,
                            'Attacking': 66.8,
                            'Movement': 65.8,
                     ...
                     'q5': ['Fuller-Mendoza',
                            'Sherman Ltd',
                            'Wall, Whitehead and Roy',
                            'Fritz, May and Faulkner',
                            'Hood Ltd',
                            'Martin-Moses',
                            'Murphy PLC',
                            'Williams Group',
                            ...
                            'Rogers Group',
                            'Powell-Li',
                            'Hughes, Mcdaniel and Hurley',
                            'Walton, Martin and Butler',
                            'Huerta, Fisher and Evans',
                            'Garcia Inc',
                            'FC Bayern München',
                            'Reed Inc'],
                     'q6': {'Left': 1029, 'Right': 971},
                     'q7': {'Left': 63.92031098153547, 'Right': 62.599382080329555},
                     'q8': {'CDM': 149,
                            'RM': 142,
                            'CF': 118,
                            'RW': 123,
                            ...
                            'GK': 120,
                            'LB': 128},
                     'q9': {'CDM': 29.79194630872483,
                            'RM': 28.690140845070424,
                            'CF': 29.983050847457626,
                            'RW': 30.178861788617887,
                            'ST': 28.866141732283463,
                            'CAM': 30.363013698630137,
                            'RB': 29.48,
                            'CB': 28.96747967479675,
                            'LWB': 29.31111111111111,
                            'LW': 29.76595744680851,
                            'CM': 30.352941176470587,
                            'RWB': 28.875862068965517,
                            'LM': 29.795774647887324,
                            'GK': 29.066666666666666,
                            'LB': 29.078125},
                     'q10': {'CDM': 182.64429530201343,
                             'RM': 177.9718309859155,
                             'CF': 179.78813559322035,
                             'RW': 179.5040650406504,
                             'ST': 181.03149606299212,
                             'CAM': 178.67808219178082,
                             'RB': 180.504,
                             'CB': 180.65040650406505,
                             'LWB': 178.6888888888889,
                             'LW': 181.00709219858157,
                             'CM': 179.10294117647058,
                             'RWB': 179.4758620689655,
                             'LM': 181.30281690140845,
                             'GK': 182.34166666666667,
                             'LB': 180.078125},
                     'q11': {'CDM': 53.97181208053691,
                             'RM': 53.197183098591545,
                             'CF': 72.314406779661,
                             'RW': 48.88699186991871,
                             'ST': 33.18818897637796,
                             'CAM': 54.81849315068494,
                             'RB': 37.493600000000015,
                             'CB': 43.83089430894309,
                             'LWB': 55.665185185185166,
                             'LW': 34.62411347517731,
                             'CM': 56.644852941176474,
                             'RWB': 43.73379310344829,
                             'LM': 35.09788732394368,
                             'GK': 40.60333333333333,
                             'LB': 34.215625},
                     'q12': {'CDM': 47.754362416107384,
                             'RM': 36.837323943661964,
                             'CF': 39.401694915254275,
                             'RW': 42.65528455284553,
                             'ST': 55.755905511811015,
                             'CAM': 63.84452054794519,
                             'RB': 32.58399999999999,
                             'CB': 40.20894308943092,
                             'LWB': 30.4014814814815,
                             'LW': 59.05886524822697,
                             'CM': 42.20735294117649,
                             'RWB': 42.04413793103448,
                             'LM': 29.25070422535212,
                             'GK': 40.05249999999999,
                             'LB': 36.83046875000001},
                     'q13': 'ST',
                     'q14': 189992,
                     'q15': {'ID': 255428,
                             'Name': 'C. Singh',
                             ...
                             'Nationality': 'Bermuda',
                             'Team': 'Liverpool',
                             'League': 'Palmer and Sons (Botswana)',
                             'Value': 100500000,
                             'Wage': 306000,
                             'Attacking': 62.3,
                             'Movement': 41.9,
                     ...
                     'q17': {'CF': 'M. Melton',
                             ...
                             'LM': 'Gallagher'},
                     'q18': 11005000,
                     'q19': {'Paris Saint Germain': 49.260000000000005,
                             'Zavala-Campbell': 51.969230769230776,
                             'Mcdaniel Group': 52.92222222222222,
                             'Vasquez Ltd': 50.372727272727275,
                             'Peterson-Lewis': 45.91818181818182,
                             'Romero, Hoffman and Hall': 47.95384615384616,
                             'Strong-Moody': 51.12,
                             'Hawkins Ltd': 49.61538461538461,
                             'Harris, Johnson and Miller': 52.57272727272728,
                             'Smith, Leon and Dunn': 45.14444444444444,
                             'Brooks-Todd': 51.06999999999999,
                             'Torres Ltd': 55.099999999999994,
                             'Austin LLC': 46.95,
                             'Miller-Brown': 48.8,
                             'Reid, Stewart and Crawford': 46.61818181818182,
                             'Wilson-Holden': 43.23076923076923,
                             'Jensen and Sons': 37.22,
                             'Porter-Christensen': 48.87777777777777,
                             'Steele, Madden and Hill': 44.63333333333334,
                             'Dodson-Henderson': 52.899999999999984,
                             'Hayes-Stark': 61.17857142857142,
                             'Robinson, Hernandez and Bowman': 48.900000000000006,
                             'Hoffman, Green and Thomas': 51.67999999999999,
                             'Brown, Riddle and Mccoy': 58.879999999999995,
                             'Garza LLC': 59.758333333333326,
                             'Leonard Ltd': 49.12307692307691,
                             'Hanna-Morrison': 43.56363636363636,
                             'Preston, Johnson and Jones': 51.491666666666674,
                             'Bowers-Owen': 52.96,
                             'Wilson Ltd': 48.292307692307695,
                             'Hardy, Strong and Durham': 51.800000000000004,
                             'Wallace, Campos and Nichols': 42.37500000000001,
                             'Figueroa, Robinson and Smith': 51.408333333333324,
                             'Torres, Moreno and Taylor': 52.67777777777778,
                             'Lewis-Swanson': 55.075,
                             'Mills, Duncan and Dennis': 50.57499999999999,
                             'Jones, Lewis and Smith': 54.65,
                             'Mora-Mcfarland': 45.67,
                             'Crawford PLC': 53.11,
                             'Tran LLC': 38.99230769230769,
                             'Drake-Cross': 54.208333333333336,
                             'Jones-Arias': 58.68750000000001,
                             'Burns-Martinez': 48.18181818181818,
                             'Fleming-Levine': 46.47272727272727,
                             'Jimenez, Dyer and Jackson': 51.73846153846154,
                             'Chapman, Garcia and Tucker': 41.300000000000004,
                             'FC Barcelona': 58.32222222222222,
                             'Lloyd, Jenkins and Buck': 51.82857142857143,
                             'Rogers Ltd': 48.599999999999994,
                             'Velez, Hancock and Curry': 58.3142857142857,
                             'Manchester United': 47.444444444444436,
                             'Campbell-Lewis': 57.08181818181818,
                             'Gallagher, Park and Patton': 52.04285714285714,
                             'Bowman Group': 65.68461538461537,
                             'Hampton-Cannon': 50.684615384615384,
                             'Flowers-Phillips': 48.08181818181818,
                             'Miller PLC': 49.23636363636363,
                             'Fisher, Owens and Escobar': 51.67,
                             'Green-Cole': 49.99166666666665,
                             'Brooks, Fernandez and Campbell': 44.15384615384615,
                             'Doyle-Simon': 47.53,
                             'Aguirre, Kelly and Taylor': 53.4,
                             'Green Ltd': 57.91111111111112,
                             'Wolfe-Burke': 56.33636363636364,
                             'Lawrence, Burgess and Alexander': 49.154545454545456,
                             'Maxwell-Rodriguez': 45.19999999999999,
                             'Taylor LLC': 40.75000000000001,
                             'Morgan, Chen and Jordan': 55.708333333333336,
                             'Dixon, Perez and Diaz': 54.80833333333333,
                             'Ibarra-Frey': 45.1,
                             'Davis-Williams': 38.800000000000004,
                             'Williams, Hammond and Ramirez': 56.92727272727272,
                             'Nelson-Wilson': 52.98461538461539,
                             'Liverpool': 41.660000000000004,
                             'Wu, Michael and Abbott': 53.73636363636363,
                             'Franklin, Bell and Strickland': 54.64166666666666,
                             'Luna Ltd': 48.86,
                             'Morales-Lewis': 46.787499999999994,
                             'Aguirre-Edwards': 39.92727272727273,
                             'Price-Taylor': 55.15999999999999,
                             'Martinez Inc': 46.9625,
                             'Ramos-Jenkins': 34.53,
                             'Brown, Adams and Salas': 46.04444444444445,
                             'Mercado, Jimenez and Berg': 50.56923076923078}}
