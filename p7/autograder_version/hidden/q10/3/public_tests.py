...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Phillips, Griffith and Cardenas',
                            'League': 'Murray-Walker (Belgium)',
                            'Value': 811000,
                            'Wage': 25000,
                            'Attacking': 66.2,
                            'Movement': 20.1,
                     ...
                     'q2': {'ID': 975644,
                            ...
                            'Team': 'Liverpool',
                            'League': 'Duran-Duarte (Netherlands Antilles)',
                            'Value': 249700000,
                            'Wage': 27000,
                            'Attacking': 80.6,
                            'Movement': 55.5,
                     ...
                     'q5': ['FC Bayern München',
                            'Herrera-Baldwin',
                            'Johnson, Gould and Hodge',
                            'Sutton, Diaz and Bryant'],
                     'q6': {'Left': 484, 'Right': 516},
                     'q7': {'Left': 65.26239669421487, 'Right': 65.7984496124031},
                     'q8': {'LWB': 56,
                            'CM': 75,
                            'CB': 69,
                            'RB': 67,
                            ...
                            'LW': 72,
                            'CAM': 68},
                     'q9': {'LWB': 29.464285714285715,
                            'CM': 30.066666666666666,
                            'CB': 29.608695652173914,
                            'RB': 29.402985074626866,
                            'RWB': 27.25974025974026,
                            'RW': 29.20967741935484,
                            'CF': 29.913793103448278,
                            'LM': 30.375,
                            'ST': 28.788732394366196,
                            'RM': 28.56923076923077,
                            'GK': 28.64788732394366,
                            'CDM': 29.403846153846153,
                            'LB': 29.095890410958905,
                            'LW': 28.48611111111111,
                            'CAM': 27.5},
                     'q10': {'LWB': 180.41071428571428,
                             'CM': 180.56,
                             'CB': 177.79710144927537,
                             'RB': 181.6865671641791,
                             'RWB': 178.83116883116884,
                             'RW': 180.11290322580646,
                             'CF': 181.0344827586207,
                             'LM': 178.53125,
                             'ST': 182.53521126760563,
                             'RM': 181.1846153846154,
                             'GK': 179.92957746478874,
                             'CDM': 176.73076923076923,
                             'LB': 178.46575342465752,
                             'LW': 180.66666666666666,
                             'CAM': 176.7058823529412}}
