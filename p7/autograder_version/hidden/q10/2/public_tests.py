...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Peters Group',
                            'League': 'Walker-Kidd (Christmas Island)',
                            'Value': 834000,
                            'Wage': 54000,
                            'Attacking': 15.5,
                            'Movement': 48.9,
                     ...
                     'q2': {'ID': 781853,
                            ...
                            'Team': 'Odom, Proctor and Jones',
                            'League': 'Jacobson, Marshall and Small (Sudan)',
                            'Value': 246000000,
                            'Wage': 484000,
                            'Attacking': 79.6,
                            'Movement': 62.7,
                     ...
                     'q5': ['FC Barcelona',
                            'Hill-Rivera',
                            'Garcia, Stewart and Willis',
                            'Bryant, Contreras and Hernandez',
                            'Rubio-Davis',
                            'Holland PLC',
                            'Johnson-Mitchell',
                            'Harper, Alvarez and Clark',
                            'Murray, Obrien and Pearson',
                            'Shah Ltd',
                            'Irwin Group',
                            'Sanchez-Miller',
                            'Rowe Group',
                            'Smith-Adams',
                            'Ramos-Robinson'],
                     'q6': {'Right': 499, 'Left': 501},
                     'q7': {'Right': 63.77555110220441, 'Left': 65.98602794411178},
                     'q8': {'SPT': 123,
                            'MID': 127,
                            'AMF': 116,
                            'GKP': 151,
                            ...
                            'WNG': 127,
                            'FWD': 119},
                     'q9': {'SPT': 28.51219512195122,
                            'MID': 28.488188976377952,
                            'AMF': 30.482758620689655,
                            'GKP': 29.23841059602649,
                            'DEF': 29.553719008264462,
                            'DMF': 29.03448275862069,
                            'WNG': 29.330708661417322,
                            'FWD': 28.88235294117647},
                     'q10': {'SPT': 178.90243902439025,
                             'MID': 181.85826771653544,
                             'AMF': 179.56896551724137,
                             'GKP': 180.04635761589404,
                             'DEF': 179.65289256198346,
                             'DMF': 177.9655172413793,
                             'WNG': 182.96850393700788,
                             'FWD': 179.11764705882354}}
