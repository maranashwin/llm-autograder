...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Age': 45,
                            'Nationality': 'Somalia',
                            'Team': 'Moore, Browning and Hernandez',
                            'League': 'Ramirez PLC (American Samoa)',
                            'Value': 169400000,
                            'Wage': 414000,
                            'Attacking': 83.3,
                            'Movement': 89.7,
                     ...
                     'q2': {'ID': 249056,
                            ...
                            'Team': 'Walker, Brown and Arellano',
                     ...
                     'q3': 'Equatorial Guinea',
                     'q4': 'RWB',
                     'q5': ['Smith-Mathews',
                            'Clark, Clements and Smith',
                            'FC Bayern München',
                            'Middleton, Montgomery and Hart',
                            'Lane-Garcia',
                            'Velasquez-Baker',
                            'Wilson-Massey',
                            'Jacobs, Freeman and Gonzalez',
                            'Williams-Smith',
                            'Walker, Brown and Arellano',
                            'Greene-Green',
                            'Case, Scott and Thompson',
                            'Green-Allen',
                            'Mills-Peterson',
                            'Ross, Aguilar and Grant',
                            'Colon LLC',
                            'Martin, Powell and Macdonald',
                            'Bruce, Marsh and Garcia',
                            'Hamilton, Barajas and Sanchez'],
                     'q6': {'Right': 1051, 'Left': 949},
                     'q7': {'Right': 68.5080875356803, 'Left': 69.03793466807166},
                     'q8': {'ST': 115,
                            'CM': 131,
                            'LB': 145,
                            'RWB': 125,
                            ...
                            'LM': 138,
                            'CF': 152},
                     'q9': {'ST': 29.591304347826085,
                            'CM': 29.633587786259543,
                            'LB': 29.517241379310345,
                            'RWB': 29.328,
                            'CAM': 30.1937984496124,
                            'CB': 29.576,
                            'RB': 29.47482014388489,
                            'GK': 29.12686567164179,
                            'RW': 30.226277372262775,
                            'CDM': 29.654411764705884,
                            'LW': 28.778523489932887,
                            'RM': 28.387096774193548,
                            'LWB': 30.727272727272727,
                            'LM': 28.81159420289855,
                            'CF': 29.00657894736842},
                     'q10': {'ST': 181.11304347826086,
                             'CM': 181.46564885496184,
                             'LB': 180.67586206896553,
                             'RWB': 179.688,
                             'CAM': 180.19379844961242,
                             'CB': 179.736,
                             'RB': 179.8705035971223,
                             'GK': 180.50746268656715,
                             'RW': 179.93430656934308,
                             'CDM': 180.91176470588235,
                             'LW': 181.5771812080537,
                             'RM': 181.23387096774192,
                             'LWB': 176.68595041322314,
                             'LM': 180.28985507246378,
                             'CF': 180.9078947368421}}
