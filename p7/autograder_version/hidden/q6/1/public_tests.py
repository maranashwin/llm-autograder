...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Age': 27,
                            'Nationality': 'Germany',
                            'Team': 'Martin, Davis and Miles',
                            'League': 'Kelly PLC (Wallis and Futuna)',
                            'Value': 580000,
                            'Wage': 35000,
                            'Attacking': 61.8,
                            'Movement': 44.1,
                     ...
                     'q4': 'RW',
                     'q5': ['Brock PLC',
                            'Thomas, Jones and Suarez',
                            'Hicks Ltd',
                            'Liverpool',
                            'Robbins, Russell and Short',
                            'Porter PLC',
                            'Watson-Cook',
                            'Koch-Schneider',
                            'Johnson LLC',
                            'Mcknight, Sharp and Williams',
                            'Stone Inc',
                            'Spencer-Robertson',
                            'Rice-Lewis',
                            'Munoz, Torres and Coleman',
                            'Bailey-Brooks',
                            'Nunez, Fields and Waller'],
                     'q6': {'Left': 465, 'Right': 535}}
