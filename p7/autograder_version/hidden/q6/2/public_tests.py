...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Wallace-Stevens',
                            'League': 'Pruitt, Petersen and Robbins (Bouvet Island (Bouvetoya))',
                            'Value': 86000,
                            'Wage': 0,
                            'Attacking': 34.5,
                            'Movement': 10.0,
                     ...
                     'q2': {'ID': 566815,
                            ...
                            'Height': 158,
                            'Preferred foot': 'Ambidextrous'},
                     'q3': 'Brunei Darussalam',
                     'q4': 'ST',
                     'q5': ['Mitchell-Miller',
                            'Ford LLC',
                            'Munoz-Stevens',
                            'Fox-Barber',
                            'Bruce, Roach and Lowe',
                            'Scott, Clark and Murphy',
                            'Li and Sons',
                            'Hawkins-Daniel',
                            'Bass PLC',
                            'Wiggins-Andrews',
                            'Clark, Park and Foley',
                            'FC Bayern München',
                            'Thomas-Young',
                            'Cruz, Johnson and Haney',
                            'Smith-Dougherty',
                            'Paris Saint Germain',
                            'Bailey Inc'],
                     'q6': {'None': 337, 'Ambidextrous': 334, 'Hands': 329}}
