...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q2': {'ID': 191034,
                            ...
                            'Team': 'Richardson-Frank',
                            'League': 'Payne-Nunez (Dominica)',
                            'Value': 249300000,
                            'Wage': 498000,
                            'Attacking': 85.0,
                            'Movement': 26.1,
                            ...
                            'Height': 201,
                            'Preferred foot': 'Left'},
                     'q3': 'Turks and Caicos Islands',
                     'q4': 'GK',
                     'q5': ['Webster, Hodge and Carey',
                            'Fernandez, Waters and Crawford',
                            'Buchanan, Torres and Mahoney',
                            'Medina LLC',
                            'Rogers, Kelly and Lopez',
                            'Dean, Johnson and Snyder',
                            'Manchester United',
                            'Moore Ltd',
                            'Sherman LLC',
                            'Young LLC',
                            ...
                            'Lawrence-Gomez',
                            'Harper and Sons',
                            'Harris, Allen and Robbins'],
                     'q6': {'Left': 1014, 'Right': 986},
                     'q7': {'Left': 65.32544378698225, 'Right': 65.65618661257606},
                     'q8': {'GK': 124,
                            'CF': 126,
                            'CB': 131,
                            'CM': 120,
                            ...
                            'LW': 144,
                            'LB': 133},
                     'q9': {'GK': 29.161290322580644,
                            'CF': 29.38888888888889,
                            'CB': 29.709923664122137,
                            'CM': 29.45,
                            'LWB': 29.454545454545453,
                            'RWB': 29.802816901408452,
                            'CDM': 29.459016393442624,
                            'RW': 29.5625,
                            'ST': 30.045112781954888,
                            'LM': 28.964285714285715,
                            'RB': 29.727941176470587,
                            'CAM': 28.84313725490196,
                            'RM': 28.68027210884354,
                            'LW': 30.958333333333332,
                            'LB': 29.18796992481203},
                     'q10': {'GK': 181.75806451612902,
                             'CF': 178.83333333333334,
                             'CB': 180.41221374045801,
                             'CM': 181.425,
                             'LWB': 181.06611570247935,
                             'RWB': 181.75352112676057,
                             'CDM': 180.64754098360655,
                             'RW': 178.6015625,
                             'ST': 178.7218045112782,
                             'LM': 181.47142857142856,
                             'RB': 180.25735294117646,
                             'CAM': 178.99346405228758,
                             'RM': 179.74149659863946,
                             'LW': 178.91666666666666,
                             'LB': 180.1654135338346},
                     'q11': {'GK': 56.14354838709674,
                             'CF': 44.20396825396827,
                             'CB': 37.60152671755727,
                             'CM': 50.12416666666665,
                             'LWB': 32.99504132231405,
                             'RWB': 38.93169014084506,
                             'CDM': 47.26885245901639,
                             'RW': 35.92968749999999,
                             'ST': 53.7075187969925,
                             'LM': 54.864285714285714,
                             'RB': 69.26029411764699,
                             'CAM': 62.89150326797383,
                             'RM': 58.88231292517005,
                             'LW': 35.552777777777784,
                             'LB': 37.45263157894738},
                     'q12': {'GK': 37.476612903225835,
                             'CF': 49.86904761904763,
                             'CB': 38.67328244274806,
                             'CM': 60.3541666666667,
                             'LWB': 55.61239669421488,
                             'RWB': 35.760563380281674,
                             'CDM': 67.56721311475411,
                             'RW': 71.66484375000002,
                             'ST': 41.562406015037595,
                             'LM': 35.006428571428565,
                             'RB': 47.67647058823526,
                             'CAM': 47.866666666666674,
                             'RM': 36.65170068027211,
                             'LW': 57.34930555555555,
                             'LB': 50.704511278195476},
                     'q13': 'CB',
                     'q14': 369148,
                     'q15': {'ID': 298720,
                             'Name': 'T. Hernandez',
                     ...
                     'q17': {'CDM': 'J. Byrd',
                             ...
                             'CAM': 'Bradley Bishop',
                             'LB': 'M. Simmons',
                             'RWB': 'Christopher Cisneros',
                             'RB': 'John Jr.',
                             'LM': 'R. Bradley'},
                     'q18': 656750,
                     'q19': {'Webster, Hodge and Carey': 49.77857142857142,
                             'Fernandez, Waters and Crawford': 45.08,
                             'Buchanan, Torres and Mahoney': 52.75,
                             'Medina LLC': 53.75,
                             'Rogers, Kelly and Lopez': 41.66666666666666,
                             'Dean, Johnson and Snyder': 42.41818181818182,
                             'Manchester United': 40.04615384615385,
                             'Moore Ltd': 52.62500000000001,
                             'Sherman LLC': 51.260000000000005,
                             'Young LLC': 49.85833333333333,
                             'Vasquez and Sons': 47.008333333333326,
                             'Logan PLC': 46.85,
                             'Ferguson LLC': 45.03333333333333,
                             'Hood-Barajas': 52.33,
                             'Bell-Carter': 44.69,
                             'Lawrence-Gomez': 47.96666666666667,
                             'Harper and Sons': 55.8,
                             'Harris, Allen and Robbins': 36.45},
                     'q20': 'Harper and Sons'}
