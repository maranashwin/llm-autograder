...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q5': ['Kline Group',
                            ...
                            'Rollins LLC',
                            'Schmidt-Martin',
                            'Barber, Jacobs and Johnson',
                            'Tyler-Miller',
                            'Fitzgerald-Benitez',
                            'Smith-Peterson',
                            'FC Barcelona',
                            'Carter, Cantu and Bell',
                            'Wright-Neal',
                            'Burnett-Henry',
                            'Paris Saint Germain',
                            'Johnson and Sons',
                            ...
                            'Young LLC',
                            'Sharp-Cox'],
                     'q6': {'Left': 493, 'Right': 507},
                     'q7': {'Left': 70.51926977687627, 'Right': 64.10059171597634},
                     'q8': {'CDM': 60,
                            'ST': 74,
                            'RM': 58,
                            'CB': 82,
                            ...
                            'LM': 63,
                            'LWB': 63},
                     'q9': {'CDM': 29.016666666666666,
                            'ST': 29.10810810810811,
                            'RM': 28.517241379310345,
                            'CB': 30.24390243902439,
                            'GK': 29.454545454545453,
                            'CM': 31.492753623188406,
                            'RW': 30.454545454545453,
                            'RB': 27.97142857142857,
                            'LW': 29.27777777777778,
                            'CAM': 28.49206349206349,
                            'RWB': 29.28125,
                            'LB': 30.074626865671643,
                            'CF': 29.22222222222222,
                            'LM': 28.77777777777778,
                            'LWB': 28.936507936507937},
                     'q10': {'CDM': 178.51666666666668,
                             'ST': 178.06756756756758,
                             'RM': 180.41379310344828,
                             'CB': 180.8658536585366,
                             'GK': 179.8181818181818,
                             'CM': 179.31884057971016,
                             'RW': 183.5909090909091,
                             'RB': 180.11428571428573,
                             'LW': 177.61111111111111,
                             'CAM': 177.42857142857142,
                             'RWB': 185.203125,
                             'LB': 184.23880597014926,
                             'CF': 182.96825396825398,
                             'LM': 184.12698412698413,
                             'LWB': 179.84126984126985},
                     'q11': {'CDM': 54.611666666666665,
                             'ST': 63.49594594594594,
                             'RM': 66.74999999999997,
                             'CB': 66.3158536585366,
                             'GK': 46.43030303030304,
                             'CM': 36.17536231884059,
                             'RW': 32.01060606060608,
                             'RB': 64.66142857142859,
                             'LW': 35.630555555555546,
                             'CAM': 32.973015873015875,
                             'RWB': 50.2921875,
                             'LB': 57.41343283582088,
                             'CF': 41.16666666666667,
                             'LM': 40.20952380952379,
                             'LWB': 37.482539682539674},
                     'q12': {'CDM': 55.82500000000002,
                             'ST': 55.821621621621645,
                             'RM': 63.11206896551726,
                             'CB': 59.65731707317072,
                             'GK': 59.21818181818182,
                             'CM': 59.96376811594203,
                             'RW': 58.05606060606061,
                             'RB': 32.01285714285714,
                             'LW': 51.675000000000004,
                             'CAM': 63.109523809523814,
                             'RWB': 65.4890625,
                             'LB': 38.01940298507463,
                             'CF': 51.265079365079345,
                             'LM': 48.66190476190477,
                             'LWB': 47.30476190476189},
                     'q13': 'LW',
                     'q14': 223894,
                     'q15': {'ID': 813246,
                             'Name': 'John Jr.',
                             ...
                             'Nationality': 'Central African Republic',
                             'Team': 'Liverpool',
                             'League': 'Ortega, Sullivan and Garcia (Central African Republic)',
                             'Value': 135300000,
                             'Wage': 276000,
                             'Attacking': 38.8,
                             'Movement': 87.4,
                     ...
                     'q17': {'LB': 'D. Baker',
                             ...
                             'LW': 'T. Wood'},
                     'q18': 2749000,
                     'q19': {'Kline Group': 53.17999999999999,
                             'Johnson Group': 49.93076923076922,
                             'Crane-Moore': 47.472727272727276,
                             'Rollins LLC': 51.63636363636363,
                             'Schmidt-Martin': 49.106666666666676,
                             'Barber, Jacobs and Johnson': 50.285714285714285,
                             'Tyler-Miller': 53.23636363636364,
                             'Fitzgerald-Benitez': 55.709999999999994,
                             'Smith-Peterson': 52.67,
                             'FC Barcelona': 40.879999999999995,
                             'Carter, Cantu and Bell': 45.23571428571429,
                             'Wright-Neal': 54.25999999999999,
                             'Burnett-Henry': 49.784615384615385,
                             'Paris Saint Germain': 51.57272727272727,
                             'Johnson and Sons': 51.46666666666667,
                             'Baldwin LLC': 52.0846153846154,
                             'Young LLC': 50.6,
                             'Sharp-Cox': 59.25000000000001},
                     'q20': 'Young LLC'}
