...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Age': 30,
                            'Nationality': 'Belize',
                            'Team': 'Graves and Sons',
                            'League': 'Cunningham and Sons (Svalbard & Jan Mayen Islands)',
                            'Value': 5700000,
                            'Wage': 85000,
                            'Attacking': 31.5,
                            'Movement': 56.2,
                     ...
                     'q5': ['Lawson-Jackson',
                            ...
                            'Edwards Group',
                            'Liverpool',
                            'Lee, Morrison and Cruz',
                            'Johnson, Rogers and Goodman',
                            'Nguyen Ltd',
                            'Medina PLC',
                            'May Group',
                            'Thompson-Rogers',
                            ...
                            'Williams-Herrera',
                            'Allen PLC',
                            'Rice, Horton and Maxwell'],
                     'q6': {'Right': 517, 'Left': 483},
                     'q7': {'Right': 66.52998065764024, 'Left': 68.68737060041408},
                     'q8': {'C': 195, 'A': 196, 'E': 185, 'D': 218, 'B': 206}}
