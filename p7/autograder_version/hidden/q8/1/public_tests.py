...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Nationality': 'Egypt',
                            'Team': 'Little Ltd',
                            'League': 'Martinez-Nguyen (Indonesia)',
                            'Value': 993000,
                            'Wage': 72000,
                            'Attacking': 55.8,
                            'Movement': 43.0,
                     ...
                     'q2': {'ID': 319659,
                            ...
                            'Nationality': 'Egypt',
                            'Team': 'Lee LLC',
                            'League': 'Turner-Burns (Northern Mariana Islands)',
                            'Value': 249100000,
                            'Wage': 498000,
                            'Attacking': 58.6,
                            'Movement': 94.8,
                     ...
                     'q4': 'CF',
                     'q5': ['Anderson-Bird',
                            'Grant, Allison and Martin',
                            'Paris Saint Germain',
                            'Phillips-Simpson',
                            'Gates, Vance and Burch',
                            'Miles Ltd',
                            'Wilson-Macdonald',
                            'Anderson Group',
                            'Johnson LLC',
                            'Sweeney-Calhoun',
                            'Smith, Smith and Bates',
                            'Smith, Fields and Jordan',
                            'Crawford-Briggs',
                            'Brennan, Walters and Ramirez',
                            'Strong, Myers and Vang',
                            'Valdez, Todd and Wright',
                            'Baker, Bailey and Gutierrez',
                            'Daniel-Johnson',
                            'Camacho, Carroll and Atkinson'],
                     'q6': {'Left': 1003, 'Right': 997},
                     'q7': {'Left': 66.35892323030907, 'Right': 68.13440320962889},
                     'q8': {'CF': 148,
                            'LM': 123,
                            'CDM': 141,
                            'LB': 134,
