...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q2': {'ID': 901420,
                            ...
                            'Team': 'Huber, Price and Carroll',
                            'League': 'Jimenez Ltd (Tajikistan)',
                            'Value': 249900000,
                            'Wage': 361000,
                            'Attacking': 38.1,
                            'Movement': 74.5,
                     ...
                     'q3': 'South Africa',
                     'q4': 'CM',
                     'q5': ['Ramos, Allen and Gardner',
                            'Liverpool',
                            'Paris Saint Germain',
                            'Whitney-Boyle',
                            'Roberts, Garcia and Drake'],
                     'q6': {'Left': 519, 'Right': 481},
                     'q7': {'Left': 62.872832369942195, 'Right': 64.03118503118503},
                     'q8': {'RM': 75,
                            'GK': 67,
                            'RWB': 77,
                            'CAM': 66,
