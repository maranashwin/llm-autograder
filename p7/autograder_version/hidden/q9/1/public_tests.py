...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Cooper-Marshall',
                            'League': 'Graves, Ryan and Wilson (Netherlands Antilles)',
                            'Value': 1900000,
                            'Wage': 77000,
                            'Attacking': 32.4,
                            'Movement': 46.5,
                     ...
                     'q2': {'ID': 109893,
                            ...
                            'Age': 33,
                            'Nationality': 'Iraq',
                            'Team': 'Key, Hughes and Hall',
                            'League': 'Brewer Group (Paraguay)',
                            'Value': 249400000,
                            'Wage': 498000,
                            'Attacking': 79.8,
                            'Movement': 27.9,
                     ...
                     'q4': 'CDM',
                     'q5': ['Larsen-Joyce',
                            'Rivas, Jones and Rhodes',
                            'Morales Ltd',
                            'Morris, Webb and Sanchez',
                            'Foster-Hopkins',
                            'Lopez PLC',
                            'Cruz-Holmes',
                            'White Group',
                            ...
                            'Clark-Pope',
                            'Zavala-Roth'],
                     'q6': {'Left': 984, 'Right': 1016},
                     'q7': {'Left': 69.1920731707317, 'Right': 67.14074803149606},
                     'q8': {'ST': 127,
                            'RWB': 116,
                            'CDM': 119,
                            'CF': 150,
                            ...
                            'RM': 134,
                            'LM': 130},
                     'q9': {'ST': 28.677165354330707,
                            'RWB': 28.775862068965516,
                            'CDM': 29.680672268907564,
                            'CF': 29.04,
                            'CAM': 28.94776119402985,
                            'GK': 29.278688524590162,
                            'CM': 29.165562913907284,
                            'RW': 28.814285714285713,
                            'LB': 29.02238805970149,
                            'LW': 29.38888888888889,
                            'CB': 29.08823529411765,
                            'LWB': 28.5703125,
                            'RB': 28.05185185185185,
                            'RM': 30.23134328358209,
                            'LM': 29.307692307692307}}
