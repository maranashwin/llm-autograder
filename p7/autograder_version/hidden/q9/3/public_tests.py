...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q2': {'ID': 541411,
                            ...
                            'Nationality': 'Maldives',
                            'Team': 'Mack-Davis',
                            'League': 'Steele, Anderson and Mitchell (Nepal)',
                            'Value': 249500000,
                            'Wage': 362000,
                            'Attacking': 29.3,
                            'Movement': 56.1,
                     ...
                     'q5': ['Gomez-Thomas',
                            ...
                            'Page-Phillips',
                            'Liverpool'],
                     'q6': {'Right': 490, 'Left': 510},
                     'q7': {'Right': 64.58163265306122, 'Left': 65.70588235294117},
                     'q8': {'CM': 78,
                            'ST': 72,
                            'LB': 53,
                            'RM': 72,
                            ...
                            'CDM': 58,
                            'RWB': 59},
                     'q9': {'CM': 29.487179487179485,
                            'ST': 28.72222222222222,
                            'LB': 27.452830188679247,
                            'RM': 28.73611111111111,
                            'CAM': 28.73134328358209,
                            'GK': 28.310344827586206,
                            'RW': 29.52112676056338,
                            'LM': 29.296875,
                            'CB': 29.716216216216218,
                            'RB': 28.8125,
                            'LW': 30.37313432835821,
                            'CF': 29.569444444444443,
                            'LWB': 30.718309859154928,
                            'CDM': 27.896551724137932,
                            'RWB': 29.491525423728813}}
