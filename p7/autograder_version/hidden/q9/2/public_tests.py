...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q2': {'ID': 117954,
                            ...
                            'Team': 'Flynn LLC',
                            'League': 'Baldwin-Rivera (Saint Pierre and Miquelon)',
                            'Value': 248900000,
                            'Wage': 483000,
                            'Attacking': 14.2,
                            'Movement': 79.4,
                     ...
                     'q4': 'MID',
                     'q5': ['Sparks-White',
                            'Lee, Nguyen and Johnson',
                            'Bailey Inc',
                            'Morse Group',
                            'King LLC',
                            'Jones-Snyder',
                            'Hill, Wagner and Watkins',
                            'Manchester United',
                            'Hendrix-Leonard',
                            'Henderson, Nichols and Cochran',
                            'Freeman, Burns and Curtis',
                            'Rios Ltd',
                            'Foster, Zimmerman and Mason',
                            'King, Armstrong and Mack',
                            'Schneider Inc',
                            'Liverpool',
                            'Christian, Wallace and Harding',
                            'Shaffer-Stevens'],
                     'q6': {'Right': 503, 'Left': 497},
                     'q7': {'Right': 67.41351888667992, 'Left': 65.22132796780684},
                     'q8': {'GKP': 132,
                            'WNG': 107,
                            'MID': 113,
                            'FWD': 127,
                            ...
                            'AMF': 142,
                            'DMF': 131},
                     'q9': {'GKP': 28.939393939393938,
                            'WNG': 30.925233644859812,
                            'MID': 29.82300884955752,
                            'FWD': 28.881889763779526,
                            'SPT': 29.0,
                            'DEF': 30.5,
                            'AMF': 29.401408450704224,
                            'DMF': 29.81679389312977}}
