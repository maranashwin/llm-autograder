...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q5': ['Liverpool',
                            'Coleman and Sons',
                            'Miller-Robinson',
                            'Henderson, Martin and Reed',
                            'Gibson PLC',
                            'Walker, Dudley and Carter',
                            'Zimmerman-Welch',
                            'Morris-Owens',
                            'Davis PLC',
                            'Schultz and Sons',
                            'Wilson, Duke and Burke',
                            'Henderson, Anderson and Figueroa',
                            'Romero, Thomas and Curry',
                            'Walton Ltd',
                            'Flores Group',
                            'Ho-Perez'],
                     'q6': {'Right': 1008, 'Left': 992},
                     'q7': {'Right': 66.12797619047619, 'Left': 64.05846774193549},
                     'q8': {'RB': 129,
                            'ST': 151,
                            'CDM': 129,
                            'LM': 134,
                            ...
                            'CAM': 157,
                            'RM': 130},
                     'q9': {'RB': 28.53488372093023,
                            'ST': 29.841059602649008,
                            'CDM': 29.88372093023256,
                            'LM': 29.507462686567163,
                            'CF': 28.016393442622952,
                            'CB': 29.11111111111111,
                            'RWB': 29.51923076923077,
                            'LB': 29.802919708029197,
                            'LW': 29.46564885496183,
                            'RW': 28.143939393939394,
                            'LWB': 30.111940298507463,
                            'GK': 29.828358208955223,
                            'CM': 29.43971631205674,
                            'CAM': 28.64968152866242,
                            'RM': 29.23846153846154},
                     'q10': {'RB': 177.5968992248062,
                             'ST': 180.18543046357615,
                             'CDM': 180.41860465116278,
                             'LM': 178.65671641791045,
                             'CF': 180.81967213114754,
                             'CB': 182.0222222222222,
                             'RWB': 178.93269230769232,
                             'LB': 181.21167883211677,
                             'LW': 179.76335877862596,
                             'RW': 178.86363636363637,
                             'LWB': 179.69402985074626,
                             'GK': 181.52985074626866,
                             'CM': 178.17021276595744,
                             'CAM': 180.98089171974522,
                             'RM': 180.01538461538462},
                     'q11': {'RB': 49.302325581395344,
                             'ST': 63.34238410596027,
                             'CDM': 48.07209302325583,
                             'LM': 57.157462686567136,
                             'CF': 43.71639344262297,
                             'CB': 53.2140740740741,
                             'RWB': 65.35576923076923,
                             'LB': 40.12700729927008,
                             'LW': 67.66946564885492,
                             'RW': 38.78181818181817,
                             'LWB': 52.9,
                             'GK': 43.85447761194029,
                             'CM': 52.543971631205714,
                             'CAM': 51.66178343949044,
                             'RM': 36.28384615384615},
                     'q12': {'RB': 46.445736434108525,
                             'ST': 47.19867549668876,
                             'CDM': 69.86124031007756,
                             'LM': 60.436567164179124,
                             'CF': 61.52213114754098,
                             'CB': 39.97703703703702,
                             'RWB': 43.11346153846153,
                             'LB': 53.81824817518247,
                             'LW': 41.7290076335878,
                             'RW': 62.7287878787879,
                             'LWB': 34.31716417910448,
                             'GK': 37.22238805970149,
                             'CM': 27.15531914893617,
                             'CAM': 39.128025477707006,
                             'RM': 36.60615384615384},
                     'q13': 'LM',
                     'q14': 263076,
                     'q15': {'ID': 517359,
                             'Name': 'Joshua Jr.',
