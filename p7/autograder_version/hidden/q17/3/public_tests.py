...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Brown-Davis',
                            'League': 'Smith-Davidson (Djibouti)',
                            'Value': 139800000,
                            'Wage': 27000,
                            'Attacking': 40.2,
                            'Movement': 34.4,
                     ...
                     'q2': {'ID': 461240,
                            ...
                            'Team': 'Cervantes-Clark',
                            'League': 'Bishop-Jones (Croatia)',
                            'Value': 249900000,
                            'Wage': 328000,
                            'Attacking': 48.5,
                            'Movement': 50.0,
                            ...
                            'Height': 192,
                            'Preferred foot': 'Left'},
                     'q3': 'Saint Pierre and Miquelon',
                     'q4': 'CAM',
                     'q5': ['Everett-Anderson'],
                     'q6': {'Left': 520, 'Right': 480},
                     'q7': {'Left': 65.3, 'Right': 65.97916666666667},
                     'q8': {'LM': 67,
                            'LW': 65,
                            'LWB': 64,
                            'RWB': 59,
                            ...
                            'GK': 64,
                            'ST': 73},
                     'q9': {'LM': 28.059701492537314,
                            'LW': 29.415384615384614,
                            'LWB': 30.71875,
                            'RWB': 28.949152542372882,
                            'RB': 28.692307692307693,
                            'CM': 28.338461538461537,
                            'CF': 29.166666666666668,
                            'CAM': 28.792207792207794,
                            'LB': 29.114285714285714,
                            'RW': 30.576271186440678,
                            'CDM': 30.26923076923077,
                            'RM': 28.613333333333333,
                            'CB': 29.0,
                            'GK': 30.3125,
                            'ST': 29.863013698630137},
                     'q10': {'LM': 183.82089552238807,
                             'LW': 177.16923076923078,
                             'LWB': 183.1875,
                             'RWB': 186.0677966101695,
                             'RB': 177.72307692307692,
                             'CM': 178.47692307692307,
                             'CF': 180.0,
                             'CAM': 178.2077922077922,
                             'LB': 181.62857142857143,
                             'RW': 182.71186440677965,
                             'CDM': 180.2051282051282,
                             'RM': 178.98666666666668,
                             'CB': 180.135593220339,
                             'GK': 175.125,
                             'ST': 178.45205479452054},
                     'q11': {'LM': 52.95074626865672,
                             'LW': 50.406153846153835,
                             'LWB': 49.320312499999986,
                             'RWB': 54.53559322033897,
                             'RB': 51.543076923076896,
                             'CM': 46.921538461538454,
                             'CF': 49.55499999999999,
                             'CAM': 52.78571428571427,
                             'LB': 50.82571428571428,
                             'RW': 47.61355932203388,
                             'CDM': 50.91538461538461,
                             'RM': 53.84266666666667,
                             'CB': 53.82711864406778,
                             'GK': 48.760937500000004,
                             'ST': 46.643835616438345},
                     'q12': {'LM': 49.14626865671642,
                             'LW': 49.59846153846154,
                             'LWB': 50.37031249999998,
                             'RWB': 48.235593220338984,
                             'RB': 47.112307692307695,
                             'CM': 51.12769230769231,
                             'CF': 50.67333333333335,
                             'CAM': 49.381818181818176,
                             'LB': 50.24142857142858,
                             'RW': 54.89152542372884,
                             'CDM': 50.10256410256408,
                             'RM': 51.365333333333325,
                             'CB': 54.79830508474575,
                             'GK': 48.6453125,
                             'ST': 49.300000000000004},
                     'q13': 'CM',
                     'q14': 139846,
                     'q15': {'ID': 813485,
                             'Name': 'Philip Jr.',
