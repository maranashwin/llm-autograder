...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q2': {'ID': 337992,
                            ...
                            'Team': 'Booker Inc',
                            'League': 'Martinez, Ramsey and Ramos (Western Sahara)',
                            'Value': 247500000,
                            'Wage': 441000,
                            'Attacking': 58.9,
                            'Movement': 83.5,
                     ...
                     'q5': ['Khan-Hill',
                            'Shaw Ltd',
                            'Andrade LLC',
                            'Peters, Smith and Roberts',
                            'Gray, Murphy and Li',
                            'Pena, Acevedo and Anderson',
                            'Allen and Sons',
                            'Cain-Russell',
                            'Marsh and Sons',
                            'Anderson, Wagner and Murphy',
                            'Manning-Arnold',
                            'Phillips Group',
                            'Thomas-Scott',
                            'Love PLC',
                            'Cantu, Wilcox and Ewing',
                            'Morales and Sons',
                            'Martin-Hart'],
                     'q6': {'Right': 525, 'Left': 475},
                     'q7': {'Right': 69.11238095238095, 'Left': 64.19157894736843},
                     'q8': {'LM': 58,
                            'CAM': 79,
                            'CDM': 69,
                            'LW': 63,
                            ...
                            'CF': 69,
                            'CM': 59},
                     'q9': {'LM': 28.06896551724138,
                            'CAM': 29.670886075949365,
                            'CDM': 29.36231884057971,
                            'LW': 29.38095238095238,
                            'LWB': 30.553571428571427,
                            'GK': 29.03030303030303,
                            'RW': 30.376623376623378,
                            'RB': 29.01388888888889,
                            'RWB': 28.333333333333332,
                            'ST': 28.81081081081081,
                            'CB': 29.863636363636363,
                            'LB': 29.029411764705884,
                            'RM': 31.43103448275862,
                            'CF': 27.855072463768117,
                            'CM': 28.93220338983051},
                     'q10': {'LM': 183.08620689655172,
                             'CAM': 177.9746835443038,
                             'CDM': 177.2608695652174,
                             'LW': 180.14285714285714,
                             'LWB': 177.48214285714286,
                             'GK': 179.46969696969697,
                             'RW': 179.33766233766235,
                             'RB': 178.06944444444446,
                             'RWB': 178.3939393939394,
                             'ST': 184.40540540540542,
                             'CB': 179.77272727272728,
                             'LB': 181.27941176470588,
                             'RM': 179.74137931034483,
                             'CF': 176.8840579710145,
                             'CM': 184.74576271186442},
                     'q11': {'LM': 60.67068965517243,
                             'CAM': 66.85696202531645,
                             'CDM': 56.984057971014494,
                             'LW': 43.83809523809524,
                             'LWB': 54.712499999999984,
                             'GK': 69.62272727272727,
                             'RW': 45.47272727272728,
                             'RB': 62.62361111111112,
                             'RWB': 33.986363636363635,
                             'ST': 49.609459459459444,
                             'CB': 44.27121212121212,
                             'LB': 50.91617647058823,
                             'RM': 43.83793103448276,
                             'CF': 53.536231884057976,
                             'CM': 45.11186440677964},
                     'q12': {'LM': 54.203448275862065,
                             'CAM': 51.12405063291141,
                             'CDM': 40.84347826086956,
                             'LW': 68.44920634920634,
                             'LWB': 59.63928571428569,
                             'GK': 61.99090909090912,
                             'RW': 50.71948051948054,
                             'RB': 49.78333333333335,
                             'RWB': 71.0878787878788,
                             'ST': 46.235135135135124,
                             'CB': 57.64393939393938,
                             'LB': 36.74117647058822,
                             'RM': 51.85689655172414,
                             'CF': 52.18695652173913,
                             'CM': 54.84915254237288},
                     'q13': 'CAM',
                     'q14': 475859,
                     'q15': {'ID': 912957,
                             'Name': 'Frank Jr.',
                             ...
                             'Nationality': 'Libyan Arab Jamahiriya',
                             'Team': 'Liverpool',
                             'League': 'Erickson, Drake and Frazier (Libyan Arab Jamahiriya)',
                             'Value': 170600000,
                             'Wage': 438000,
                             'Attacking': 12.1,
                             'Movement': 87.0,
