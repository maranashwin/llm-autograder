...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                            ...
                            'Team': 'Maldonado and Sons',
                            'League': 'Larson and Sons (Australia)',
                            'Value': 922000,
                            'Wage': 65000,
                            'Attacking': 38.6,
                            'Movement': 59.7,
                     ...
                     'q5': ['Hernandez-Adams',
                            'Wells, Kelly and Cox',
                            'Porter-Barker',
                            'Carter, Evans and Simon',
                            'Harvey, Nguyen and Smith',
                            'Howard and Sons',
                            'Medina PLC',
                            'FC Bayern München',
                            'Rose, Romero and Gallegos',
                            'Wilson Ltd',
                            'Grant-Wong',
                            'Ward Group',
                            'Pineda-Flynn',
                            ...
                            'Baker Inc',
                            'Johnson-Ray',
                            'Hunt, Ortega and Howell'],
                     'q6': {'Left': 473, 'Right': 527},
                     'q7': {'Left': 66.09302325581395, 'Right': 67.21442125237192},
                     'q8': {'LWB': 74,
                            'ST': 77,
                            'LW': 74,
                            'CF': 62,
                            ...
                            'LM': 56,
                            'CM': 62},
                     'q9': {'LWB': 30.37837837837838,
                            'ST': 29.142857142857142,
                            'LW': 28.972972972972972,
                            'CF': 31.35483870967742,
                            'RWB': 30.81967213114754,
                            'RB': 29.19736842105263,
                            'GK': 28.803030303030305,
                            'LB': 28.92063492063492,
                            'RM': 29.76923076923077,
                            'RW': 30.852459016393443,
                            'CDM': 28.914285714285715,
                            'CAM': 30.28125,
                            'CB': 29.81159420289855,
                            'LM': 29.214285714285715,
                            'CM': 28.806451612903224},
                     'q10': {'LWB': 181.05405405405406,
                             'ST': 179.41558441558442,
                             'LW': 182.52702702702703,
                             'CF': 181.48387096774192,
                             'RWB': 180.86885245901638,
                             'RB': 180.1578947368421,
                             'GK': 180.27272727272728,
                             'LB': 179.34920634920636,
                             'RM': 177.96923076923076,
                             'RW': 181.672131147541,
                             'CDM': 183.67142857142858,
                             'CAM': 178.0,
                             'CB': 175.14492753623188,
                             'LM': 181.35714285714286,
                             'CM': 180.0},
                     'q11': {'LWB': 65.93918918918918,
                             'ST': 64.39220779220778,
                             'LW': 63.28648648648648,
                             'CF': 43.34516129032258,
                             'RWB': 46.50327868852459,
                             'RB': 44.53421052631579,
                             'GK': 56.16666666666668,
                             'LB': 37.1111111111111,
                             'RM': 47.91230769230768,
                             'RW': 25.285245901639335,
                             'CDM': 48.16285714285715,
                             'CAM': 45.489062499999996,
                             'CB': 55.78695652173915,
                             'LM': 38.82321428571428,
                             'CM': 45.6483870967742},
                     'q12': {'LWB': 73.55270270270269,
                             'ST': 56.327272727272735,
                             'LW': 43.243243243243256,
                             'CF': 32.3725806451613,
                             'RWB': 58.7377049180328,
                             'RB': 41.43815789473686,
                             'GK': 34.9318181818182,
                             'LB': 38.73174603174603,
                             'RM': 42.506153846153836,
                             'RW': 35.69672131147541,
                             'CDM': 59.31857142857143,
                             'CAM': 57.93593750000001,
                             'CB': 26.359420289855073,
                             'LM': 56.23214285714285,
                             'CM': 66.21774193548386},
                     'q13': 'RB',
                     'q14': 404547,
                     'q15': {'ID': 536375,
                             'Name': 'T. Meza',
                             ...
                             'Nationality': 'Vietnam',
                             'Team': 'Liverpool',
                             'League': 'Douglas, Wood and Conley (Brunei Darussalam)',
                             'Value': 0,
                             'Wage': 0,
                             'Attacking': 20.3,
                             'Movement': 27.2,
