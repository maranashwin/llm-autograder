...
def get_expected_json():
    ...
    expected_json = {'q1': {'ID': 158023,
                     ...
                     'q5': ['Paris Saint Germain',
                            'Simmons, Williams and Thompson',
                            'Manchester United',
                            'Hawkins-Carey',
                            'Carter LLC',
                            'Myers, Patterson and Graham',
                            'Hensley, Thomas and Perry',
                            'Gutierrez, Conley and Gonzalez',
                            'Molina PLC',
                            'Morales and Sons',
                            'Mathews, Ray and Brown',
                            'Johnston PLC',
                            'Wood PLC',
                            'Mitchell Group'],
                     'q6': {'Left': 498, 'Right': 502},
                     'q7': {'Left': 67.41967871485944, 'Right': 67.16932270916335},
                     'q8': {'RWB': 66,
                            'CAM': 65,
                            'CF': 79,
                            'RW': 67,
                     ...
                     'q9': {'RWB': 30.5,
                            'CAM': 28.4,
                            'CF': 28.025316455696203,
                            'RW': 29.91044776119403,
                            'ST': 29.728571428571428,
                            'RB': 29.72222222222222,
                            'LWB': 28.63768115942029,
                            'CDM': 28.551020408163264,
                            'LW': 29.808823529411764,
                            'CM': 29.379310344827587,
                            'LM': 29.238805970149254,
                            'GK': 29.366197183098592,
                            'CB': 31.692307692307693,
                            'RM': 29.0,
                            'LB': 28.83582089552239},
                     'q10': {'RWB': 178.84848484848484,
                             'CAM': 182.09230769230768,
                             'CF': 175.0253164556962,
                             'RW': 178.1492537313433,
                             'ST': 178.57142857142858,
                             'RB': 180.95833333333334,
                             'LWB': 179.7246376811594,
                             'CDM': 185.10204081632654,
                             'LW': 185.33823529411765,
                             'CM': 176.9655172413793,
                             'LM': 178.16417910447763,
                             'GK': 178.49295774647888,
                             'CB': 176.55384615384617,
                             'RM': 183.7462686567164,
                             'LB': 180.56716417910448},
                     'q11': {'RWB': 74.83030303030303,
                             'CAM': 41.07076923076922,
                             'CF': 34.10886075949367,
                             'RW': 40.213432835820896,
                             'ST': 48.06571428571429,
                             'RB': 61.10277777777776,
                             'LWB': 49.72173913043478,
                             'CDM': 65.3448979591837,
                             'LW': 32.81323529411764,
                             'CM': 65.14310344827585,
                             'LM': 45.695522388059686,
                             'GK': 63.67464788732393,
                             'CB': 52.56000000000001,
                             'RM': 46.4865671641791,
                             'LB': 35.78805970149255},
                     'q12': {'RWB': 63.66212121212121,
                             'CAM': 67.79384615384615,
                             'CF': 45.168354430379765,
                             'RW': 63.26567164179104,
                             'ST': 52.602857142857125,
                             'RB': 50.38750000000001,
                             'LWB': 46.91739130434783,
                             'CDM': 54.35918367346939,
                             'LW': 27.560294117647057,
                             'CM': 41.8103448275862,
                             'LM': 45.429850746268656,
                             'GK': 61.13521126760564,
                             'CB': 55.66615384615385,
                             'RM': 47.59850746268656,
                             'LB': 28.223880597014933},
                     'q13': 'CF',
                     'q14': 846493,
                     'q15': {'ID': 42630,
                             'Name': 'J. Wright',
                             ...
                             'Team': 'Liverpool',
                             'League': 'Foster, Odom and Hill (Antigua and Barbuda)',
                             'Value': 176900000,
                             'Wage': 463000,
                             'Attacking': 93.6,
                             'Movement': 76.2,
