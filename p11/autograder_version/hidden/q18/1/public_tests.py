...
def get_expected_json():
    ...
    expected_json = {'q1': [65.82234264241029, 0.22149254317067757, 0.7488497382730928],
                     'q2': 1.6943481972073928,
                     'q3': 56901.01544677526,
                     'q6': {'Red Giant': -0.249679203774739,
                            'White Dwarf': -0.02058795279315686,
                            'Neutron Star': -0.3383509736099299},
                     ...
                     'q14': 31.977535664374308,
                     'q15': [36.95777117807715, 44.08601418404725],
                     'q16': [0.7714046235798749, 1.136300565865296],
                     'q17': ['GJ 8022 3', 'TOI 7806 a', 'ups-5072 3', 'gam1-4965 e', 'rho-9028 3'],
                     'q18': [1285.5887547924071, 2571.1775095848143]}
