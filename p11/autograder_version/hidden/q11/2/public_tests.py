...
def get_expected_json():
    ...
    expected_json = {'q1': [0.1248158030354134,
                            0.03924498318578036,
                            0.009086399358122717,
                            0.08378553174684818],
                     'q2': 0.7896522696431371,
                     'q3': 21688758.93626158,
                     'q6': {'Red Giant': -0.3433395952314727,
                            'White Dwarf': 0.4185119161246139,
                            'Neutron Star': 0.13182360189891673},
