...
def get_expected_json():
    ...
    expected_json = {'q1': [0.1091461708466597, 5.378595861508875, 0.04175597628943651],
                     'q2': 1.6612488887968375,
                     'q3': 2163563.8076573624,
                     'q6': {'Red Giant': -0.30221920835029187,
                            'White Dwarf': -0.049486245992012796,
                            'Neutron Star': 1.2157832515893252},
                     'q10': ['broken_data/toi'],
                     'q11': ['broken_data/kepler/100']}
