...
def get_expected_json():
    ...
    expected_json = {'q1': [0.24745381671539657,
                            0.21197871066646998,
                            0.779807704334388,
                            0.0366927348255419],
                     'q2': 1.0054928722572456,
                     'q3': 10291086.011102105,
                     'q6': {'Red Giant': -0.2383901917657832, 'White Dwarf': -0.553838362911185},
                     'q10': ['broken_data/toi'],
                     'q11': ['broken_data/kepler/100'],
                     'q12': ['broken_data/kepler/100/other'],
                     'q13': ['broken_data']}
