...
def get_expected_json():
    ...
    expected_json = {'q1': [0.00017865439682438933,
                            0.6754865307559891,
                            0.04808547468405863,
                            0.005665050238997247],
                     'q2': 1.8066589081787996,
                     'q3': 16245083.15221928,
                     'q6': {'Red Giant': -0.35759322790825115,
                            'White Dwarf': -0.19614296437021111,
                            'Neutron Star': -1.012961486557795},
                     'q10': ['broken_data&toi/tois.json', 'broken_data&toi/extra_file.json'],
                     'q11': ['broken_data&kepler&100/other/others.json',
                             'broken_data&kepler&100/extra_file.json',
                     ...
                     'q12': ['broken_data&kepler&100&other/others.json',
                             'broken_data&kepler&100&other/extra_file.json']}
