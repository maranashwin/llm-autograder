...
def get_expected_json():
    ...
    expected_json = {'q1': [0.018278150585320885,
                            0.17757331989373973,
                            6.492035114247055,
                            0.9035169203473113],
                     'q2': 1.62653886514914,
                     'q3': 11214222.83617619,
                     'q6': {'Red Giant': -0.27465225709270374,
                            'White Dwarf': -0.14847391925524123,
                            'Neutron Star': -0.5234377480883243}}
