...
def get_expected_json():
    ...
    expected_json = {'q1': [0.19177866322538867,
                            0.040589099596236265,
                            0.28692514818038567,
                            0.011381925820323264],
                     'q2': 0.9777384332837127,
                     'q3': 35499828.06043022,
                     'q6': {'Red Giant': -0.23012157389627255,
                            'White Dwarf': -0.25158411784473633,
                            'Neutron Star': -0.22308130627389844}}
