...
def get_expected_json():
    ...
    expected_json = {'q1': [0.6028153653053143, 0.02289774165188214, 0.03405638851588301],
                     'q2': 1.5079871500807,
                     'q3': 154166841.49221417,
                     'q6': {'Red Giant': -0.19558262370721805,
                            'White Dwarf': -0.09209765826594823,
                            'Neutron Star': -0.30146134351309456},
                     ...
                     'q14': 354.6908590024391,
                     'q15': [3.6292387518079043, 3.966360671477801],
                     'q16': [3.4533073093276196, 5.086818162283711],
                     'q17': ['kap 9752 a',
                             'gam 9681 a',
                             'EPIC-1465 a',
                             'b Cen AB b',
