...
def get_expected_json():
    ...
    expected_json = {'q1': [0.4062876548665458, 0.10052319428954452, 6.264484758006659],
                     'q2': 1.539083901171143,
                     'q3': 1415807.3919267561,
                     'q6': {'Red Giant': -0.22622928850066693,
                            'White Dwarf': -0.4850974304910827,
                            'Neutron Star': -0.9678257776850452},
                     ...
                     'q14': 7.124128621554082,
                     'q15': [101.28801648186652, 106.31966669108152],
                     'q16': [0.13790482615439173, 0.20313766239510356],
                     'q17': ['DP-1356 4',
                             'eps 3510 1',
                             'Kepler-9710 b',
                             'xi-7333 d',
                             ...
                             'alf-481 3',
                             'mu2 2719 2'],
                     'q18': [911.517053537803, 1083.9825655134716],
                     'q19': ['eps-8421 3', 'bet-9097 2', 'gam1 3856 2', 'nu 9417 b'],
                     'q20': []}
