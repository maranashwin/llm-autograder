...
def get_expected_json():
    ...
    expected_json = {'q1': [],
                     'q6': {'Red Giant': -0.36481834228273563,
                            'White Dwarf': -0.2233142184694658,
                            'Neutron Star': -0.7942697331422434},
                     ...
                     'q14': 186.58194170786433,
                     'q15': [77.46684343705277, 87.95230323797719],
                     'q16': [2.0603851493809198, 3.035004898307523],
                     'q17': ['gam-86 b', 'gam1-2485 e'],
                     'q18': [1242.275445842606, 1477.3227989892046],
                     'q19': ['GJ 3756 c',
                             'nu 3210 2',
                             'gam1-1145 3',
                             'mu 1860 c',
