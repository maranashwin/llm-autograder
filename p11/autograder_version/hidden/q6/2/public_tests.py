...
def get_expected_json():
    ...
    expected_json = {'q1': [0.0004230733286566805,
                            2.3700567939095936,
                            1.7936372614501832,
                            0.08226044806491074],
                     'q2': 1.13209305106137,
                     'q3': 1302964.9258750346,
                     'q6': {'Red Giant': -0.23917766732144016,
                            'White Dwarf': -0.226919810823262,
                            'Neutron Star': -0.21181818571831165}}
