...
def get_expected_json():
    ...
    expected_json = {'q1': [216495.31853581898, 215944.87249258577, 215532.12435359438],
                     'q2': 0.002237293472030457,
                     'q3': -0.37806163607370036,
                     'q6': {'Red Giant': -0.02548807672369097,
                            'White Dwarf': 2.787333333333333,
                            'Neutron Star': 2.86},
                     'q10': ['broken_data\\toi\\tois.json'],
                     ...
                     'q14': 1.0000991982973964,
                     'q15': [333.59999999999997, 778.4],
                     'q16': [1.204068181137186, 1.7736260760497164],
                     'q17': ['GJ 422 b',
                             'HD 10697 b',
                             'HD 114729 b',
                             'HD 145934 b',
